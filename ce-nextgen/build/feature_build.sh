...
chmod +x ce-nextgen/build/build_jar.sh
chmod +x ce-nextgen/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD ce-nextgen/build.properties
ce-nextgen/build/build_jar.sh
ce-nextgen/build/build_dist.sh || true
