...
public class FaktoryJob {
    ...
    public FaktoryJob(io.harness.ccm.governance.faktory.JobType jobType, Object payload) {
        this(jobType, null, payload);
    }

    public FaktoryJob(io.harness.ccm.governance.faktory.JobQueue queue, Object payload) {
        this(null, queue, payload);
    }

    public FaktoryJob(io.harness.ccm.governance.faktory.JobType jobType, io.harness.ccm.governance.faktory.JobQueue queue, Object payload) {
        this(jobType, queue, new Object[]{payload});
    }

    public FaktoryJob(io.harness.ccm.governance.faktory.JobType jobType, io.harness.ccm.governance.faktory.JobQueue queue, Object[] args) {
