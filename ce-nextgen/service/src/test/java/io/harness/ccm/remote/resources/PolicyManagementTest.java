...
public class PolicyManagementTest extends CategoryTest {
    ...
    public void testCreatePolicy() {
        policymanagement.create(
                ACCOUNT_ID, CreatePolicyDTO.builder().policyStore(policyStore).build());
    ...
    public void testUpadtePolicy() {
        ResponseDTO<PolicyStore> res=policymanagement.updatePolicy(ACCOUNT_ID,CreatePolicyDTO.builder().policyStore(policyStore).build());
