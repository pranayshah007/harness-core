...
@Slf4j
@OwnedBy(IDP)
public class ScorecardChecksResourceImpl implements Resource {
  public static final String IDP_SCORECARD_CHECKS = "IDP_SCORECARD_CHECKS";

  @Override
  public String getType() {
    return IDP_SCORECARD_CHECKS;
  }
