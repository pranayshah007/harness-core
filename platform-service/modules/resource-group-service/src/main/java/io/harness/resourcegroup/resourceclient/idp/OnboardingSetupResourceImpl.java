...
@Slf4j
@OwnedBy(IDP)
public class OnboardingSetupResourceImpl implements Resource {
  public static final String IDP_ONBOARDING_SETUP = "IDP_ONBOARDING_SETUP";

  @Override
  public String getType() {
    return IDP_ONBOARDING_SETUP;
  }
