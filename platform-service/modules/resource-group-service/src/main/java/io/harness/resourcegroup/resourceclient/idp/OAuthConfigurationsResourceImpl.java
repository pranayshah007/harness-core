...
@Slf4j
@OwnedBy(IDP)
public class OAuthConfigurationsResourceImpl implements Resource {
  public static final String IDP_OAUTH_CONFIGURATIONS = "IDP_OAUTH_CONFIGURATIONS";

  @Override
  public String getType() {
    return IDP_OAUTH_CONFIGURATIONS;
  }
