...
@Slf4j
@OwnedBy(IDP)
public class ScorecardDataSourcesResourceImpl implements Resource {
  public static final String IDP_SCORECARD_DATA_SOURCES = "IDP_SCORECARD_DATA_SOURCES";

  @Override
  public String getType() {
    return IDP_SCORECARD_DATA_SOURCES;
  }
