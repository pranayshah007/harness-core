...
public class NotificationSettingsServiceImpl implements NotificationSettingsService {
  ...
  List<String> getEmailsForUserIds(List<String> userIds, String accountId) {
    ...
    try {
      users =
          NGRestUtils.getCgResponse(userClient.listUsers(accountId, UserFilterNG.builder().userIds(userIds).build()));
  ...
  public SmtpConfigResponse getSmtpConfigResponse(String accountId) {
    ...
    try {
      smtpConfigResponse = NGRestUtils.getCgResponse(smtpConfigClient.getSmtpConfig(accountId));
    } catch (Exception ex) {
