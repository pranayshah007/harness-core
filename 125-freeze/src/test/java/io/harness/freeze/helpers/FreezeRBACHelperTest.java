...
public class FreezeRBACHelperTest extends CategoryTest {
    ...
    private String yaml1 = "freeze:\n  identifier: \"idx\"\n  name: \"name\"\n  description: \"desc\"\n  orgIdentifier: \"default\"\n  projectIdentifier: \"Sample\"\n  status: \"Enabled\"\n  entityConfigs:\n    - name: \"rule1\"\n      entities:\n      - filterType: \"Equals\"\n        type: \"Service\"\n        entityRefs:\n          - \"s1\"";
    private String yaml2 = "freeze:\n  identifier: \"idx\"\n  name: \"name\"\n  description: \"desc\"\n  orgIdentifier: \"default\"\n  projectIdentifier: \"Sample\"\n  status: \"Enabled\"\n  entityConfigs:\n    - name: \"rule1\"\n      entities:\n      - filterType: \"All\"\n        type: \"Service\"";

    public final Map<FreezeEntityType, Pair<String,String>> entityTypeToResourceAndPermissionMap = Maps.of(FreezeEntityType.ENVIRONMENT, MutablePair.of("ENVIRONMENT","core_environment_view"),FreezeEntityType.SERVICE,MutablePair.of("SERVICE","core_service_view"),FreezeEntityType.ORG,MutablePair.of("ORGANIZATION","core_organization_view"),FreezeEntityType.PROJECT,MutablePair.of("PROJECT","core_project_view"));

    @Test(expected = NGAccessDeniedException.class)
    @Owner(developers = ABHISHEK)
    @Category(UnitTests.class)
    public void testCheckAccessNegative () {
        Mockito.doThrow(new NGAccessDeniedException("",USER, Collections.singletonList(PermissionCheckDTO.builder().build()))).when(accessControlClient).checkForAccessOrThrow(ResourceScope.of("kmpySmUISimoRrJL6NL73w", "default", "Sample"),
