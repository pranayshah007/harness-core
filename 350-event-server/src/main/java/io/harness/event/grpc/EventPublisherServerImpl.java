  ...
  public io.harness.ccm.commons.entities.events.PublishedMessage toPublishedMessage(
    ...
    try {
      ...
      if (("5ee158b22aa4186d1c2e927e".equals(clusterId) || "5ee15b482aa4186d1c9c1ef6".equals(clusterId)
        ...
        log.info("Event publishedMessage for clusterId: {}, {}", clusterId, publishedMessage);
        try {
          String uuid = hPersistence.save(publishedMessage);
          log.info("published message save uuid for clusterId: {}, {}", clusterId, uuid);
        } catch (Exception e) {
          log.error("Encountered error while persisting message", e);
        }
      }
