...
@Slf4j
@Singleton
public class HarnessCDCurrentGenEventsHandler extends SafeHandler<HarnessCDCurrentGenChangeSource> {
  @Inject private ChangeSourceService changeSourceService;

  @Override
  public void handleUnsafely(HarnessCDCurrentGenChangeSource changeSource) {
