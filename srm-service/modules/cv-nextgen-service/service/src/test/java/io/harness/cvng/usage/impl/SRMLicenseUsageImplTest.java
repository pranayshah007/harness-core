...
public class SRMLicenseUsageImplTest extends CvNextGenTestBase {
  ...
  public void testListLicenseUsage() {
    MonitoredServiceDTO monitoredServiceDTO = createMonitoredServiceDTOBuilder("ms1", "service1", "env1").build();
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO);
    MonitoredServiceDTO monitoredServiceDTO1 = createMonitoredServiceDTOBuilder("ms12", "service2", "env2").build();
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO1);
    monitoredServiceService.setHealthMonitoringFlag(builderFactory.getProjectParams(), "ms1", true);
    ...
    PageableUsageRequestParams usageRequestParams =
        DefaultPageableUsageRequestParams.builder()
            ...
            .build();
    Page<ActiveMonitoredServiceDTO> result = licenseUsageInterface.listLicenseUsage(
        builderFactory.getContext().getAccountId(), ModuleType.SRM, 10l, usageRequestParams);

    List<ActiveMonitoredServiceDTO> activeMonitoredServiceDTOList = new ArrayList<>(result.toList());
    assertThat(result.getTotalElements()).isEqualTo(2);
    activeMonitoredServiceDTOList.sort(Comparator.comparing(ActiveMonitoredServiceDTO::getIdentifier));
    assertThat(activeMonitoredServiceDTOList.get(0).getIdentifier()).isEqualTo("ms1");
    assertThat(activeMonitoredServiceDTOList.get(1).getIdentifier()).isEqualTo("ms12");
  }
  ...
  public void testListLicenseUsage_serviceFilter() {
    ...
    List<ActiveMonitoredServiceDTO> activeMonitoredServiceDTOList = new ArrayList<>(result.toList());
    activeMonitoredServiceDTOList.sort(Comparator.comparing(ActiveMonitoredServiceDTO::getIdentifier));
    assertThat(activeMonitoredServiceDTOList.get(0).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(1).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(0).getIdentifier()).isEqualTo("ms12");
    assertThat(activeMonitoredServiceDTOList.get(1).getIdentifier()).isEqualTo("ms2");
  }
  ...
  public void testListLicenseUsage_projectFilter() {
    ...
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO2);
    MonitoredServiceDTO monitoredServiceDTO3 = createMonitoredServiceDTOBuilder("ms2", "service2", "env2").build();
    monitoredServiceDTO3.setProjectIdentifier("newProject");
    metricPackService.createDefaultMetricPackAndThresholds(
        builderFactory.getContext().getAccountId(), builderFactory.getContext().getOrgIdentifier(), "newProject");
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO3);
    MonitoredServiceDTO monitoredServiceDTO4 = createMonitoredServiceDTOBuilder("ms3", "service3", "env3").build();
    ...
    assertThat(activeMonitoredServiceDTOList.get(0).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(1).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(0).getProjectIdentifier()).isEqualTo("newProject");
    assertThat(activeMonitoredServiceDTOList.get(1).getProjectIdentifier()).isEqualTo("newProject");
    assertThat(activeMonitoredServiceDTOList.get(0).getIdentifier()).isEqualTo("ms12");
    assertThat(activeMonitoredServiceDTOList.get(1).getIdentifier()).isEqualTo("ms2");
  }
  ...
  public void testListLicenseUsage_orgFilter() {
    ...
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO1);
    MonitoredServiceDTO monitoredServiceDTO2 = createMonitoredServiceDTOBuilder("ms13", "service2", "env3").build();
    monitoredServiceDTO2.setOrgIdentifier("newOrg");
    metricPackService.createDefaultMetricPackAndThresholds(
        builderFactory.getContext().getAccountId(), "newOrg", builderFactory.getContext().getProjectIdentifier());
    monitoredServiceService.create(builderFactory.getContext().getAccountId(), monitoredServiceDTO2);
    MonitoredServiceDTO monitoredServiceDTO3 = createMonitoredServiceDTOBuilder("ms2", "service2", "env2").build();
    ...
    assertThat(result.getTotalElements()).isEqualTo(2);
    List<ActiveMonitoredServiceDTO> activeMonitoredServiceDTOList = new ArrayList<>(result.toList());
    activeMonitoredServiceDTOList.sort(
        Comparator.comparing(ActiveMonitoredServiceDTO::getIdentifier, Comparator.reverseOrder()));
    assertThat(activeMonitoredServiceDTOList.get(0).getOrgIdentifier()).isEqualTo("newOrg");
    assertThat(activeMonitoredServiceDTOList.get(1).getOrgIdentifier()).isEqualTo("newOrg");
    assertThat(activeMonitoredServiceDTOList.get(0).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(1).getServiceIdentifier()).isEqualTo("service2");
    assertThat(activeMonitoredServiceDTOList.get(0).getIdentifier()).isEqualTo("ms13");
    assertThat(activeMonitoredServiceDTOList.get(1).getIdentifier()).isEqualTo("ms12");
  }
