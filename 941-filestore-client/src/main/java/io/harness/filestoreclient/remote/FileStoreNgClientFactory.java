...
public class FileStoreNgClientFactory implements Provider<FileStoreClient> {
  ...
  public FileStoreNgClientFactory(String baseUrl, TokenGenerator tokenGenerator) {
  ...
  private OkHttpClient getUnsafeOkHttpClient() {
    try {
      ...
      return Http.getDefaultOkHttpClient()
          ...
          .addInterceptor(new FileStoreDelegateAuthInterceptor(tokenGenerator))
