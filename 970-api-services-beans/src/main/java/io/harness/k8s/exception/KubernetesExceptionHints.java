...
public class KubernetesExceptionHints {
  ...
  public final String API_CLIENT_CA_CERT_INVALID =
      "Check if given {} field is a valid X.509 certificate and is from a trusted or verified source.";
  public final String API_CLIENT_CA_CERT_INCOMPLETE =
      "Check if given {} field is properly encoded in base64 and all data, header and footer are in place";
