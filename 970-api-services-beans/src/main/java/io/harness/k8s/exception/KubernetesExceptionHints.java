...
public class KubernetesExceptionHints {
  ...
  public final String API_CLIENT_CERT_INVALID =
      "There is an issue with the certificate and it cannot be trusted or verified.";
  public final String API_CLIENT_CERT_INCOMPLETE =
      "Check if given certificate is in encoded in base64 and all data, header and footer are in place";
