...
@Singleton
@Slf4j
public class NgLicenseHttpClientFactory extends AbstractHttpClientFactory implements Provider<NgLicenseHttpClient> {
  protected NgLicenseHttpClientFactory(ServiceHttpClientConfig ngManagerConfig, String serviceSecret,
