...
public class StatusUtils {
  ...
  private final EnumSet<Status> METRIC_STATUSES =
      EnumSet.of(ABORTED, FAILED, SUCCEEDED, RUNNING, INTERVENTION_WAITING, WAIT_STEP_RUNNING, APPROVAL_WAITING,
  ...
  public EnumSet<Status> metricStatuses() {
