...
public class TemplateYamlUtilsTest extends CategoryTest {
  ...
  public void testWriteString() throws IOException {
    ...
    assertThat(TemplateYamlUtils.writeString(Map.of("k", "Some \n Name")).replaceFirst("---\n", ""))
        .isEqualTo("k: \"Some \\n Name\"\n");
    assertThat(TemplateYamlUtils.writeString(Map.of("k", new TextNode("abc"))).replaceFirst("---\n", ""))
        .isEqualTo("k: abc\n");
    assertThat(TemplateYamlUtils.writeString(Map.of("k", new TextNode("+1234"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234\"\n");
    assertThat(TemplateYamlUtils.writeString(Map.of("k", new TextNode("+1234.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.12\"\n");
    assertThat(TemplateYamlUtils.writeString(Map.of("k", new TextNode("+1234."))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+1234.\"\n");
    assertThat(TemplateYamlUtils.writeString(Map.of("k", new TextNode("+.12"))).replaceFirst("---\n", ""))
        .isEqualTo("k: \"+.12\"\n");
  }
