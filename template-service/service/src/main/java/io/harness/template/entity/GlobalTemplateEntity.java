  ...
  public static List<MongoIndex> mongoIndexes() {
    return ImmutableList.<MongoIndex>builder()
        .add(CompoundMongoIndex.builder()
                 ...
                 .unique(true)
                 .field(GlobalTemplateEntityKeys.accountId)
                 .field(GlobalTemplateEntityKeys.orgIdentifier)
                 .field(GlobalTemplateEntityKeys.projectIdentifier)
        ...
        .add(CompoundMongoIndex.builder()
                 ...
                 .field(GlobalTemplateEntityKeys.projectIdentifier)
                 .field(GlobalTemplateEntityKeys.identifier)
                 .field(GlobalTemplateEntityKeys.isStableTemplate)
                 .field(GlobalTemplateEntityKeys.yamlGitConfigRef)
                 .field(GlobalTemplateEntityKeys.branch)
                 .build())
        .add(CompoundMongoIndex.builder()
                 ...
                 .field(GlobalTemplateEntityKeys.projectIdentifier)
                 .field(GlobalTemplateEntityKeys.identifier)
                 .field(GlobalTemplateEntityKeys.isLastUpdatedTemplate)
                 .field(GlobalTemplateEntityKeys.yamlGitConfigRef)
                 .field(GlobalTemplateEntityKeys.branch)
                 .build())
        .add(CompoundMongoIndex.builder()
                 .name("accountId_org_project_childType")
                 .fields(Arrays.asList(GlobalTemplateEntityKeys.accountId, GlobalTemplateEntityKeys.orgIdentifier,
                     GlobalTemplateEntityKeys.projectIdentifier, GlobalTemplateEntityKeys.childType))
                 .build())
        .add(CompoundMongoIndex.builder()
        ...
        .add(SortCompoundMongoIndex.builder()
                 ...
                 .fields(Arrays.asList(GlobalTemplateEntityKeys.accountId, GlobalTemplateEntityKeys.projectIdentifier,
                     GlobalTemplateEntityKeys.orgIdentifier, GlobalTemplateEntityKeys.yamlGitConfigRef,
                     GlobalTemplateEntityKeys.branch))
                 .descSortField(GlobalTemplateEntityKeys.createdAt)
                 .build())
        .add(SortCompoundMongoIndex.builder()
                 .name("accountId_project_org_isDefault")
                 .fields(Arrays.asList(GlobalTemplateEntityKeys.accountId, GlobalTemplateEntityKeys.projectIdentifier,
                     GlobalTemplateEntityKeys.orgIdentifier, GlobalTemplateEntityKeys.isFromDefaultBranch))
                 .descSortField(GlobalTemplateEntityKeys.createdAt)
                 .build())
        .add(CompoundMongoIndex.builder()
                 .name("accountId_repoURL_filePath")
                 .field(GlobalTemplateEntityKeys.accountId)
                 .field(GlobalTemplateEntityKeys.repoURL)
                 .field(GlobalTemplateEntityKeys.filePath)
                 .build())
        .add(CompoundMongoIndex.builder()
                 ...
                 .field(GlobalTemplateEntityKeys.orgIdentifier)
                 .field(GlobalTemplateEntityKeys.projectIdentifier)
                 .field(GlobalTemplateEntityKeys.repo)
                 .build())
        .build();
  }
