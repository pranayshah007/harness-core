...
public class UtilizationDataRecord extends TableRecordImpl<UtilizationDataRecord> implements Record20<OffsetDateTime, OffsetDateTime, String, String, String, String, Double, Double, Double, Double, Double, Double, Double, Double, String, Double, Double, Double, Double, Double> {
    ...
    @Override
    public Row20<OffsetDateTime, OffsetDateTime, String, String, String, String, Double, Double, Double, Double, Double, Double, Double, Double, String, Double, Double, Double, Double, Double> valuesRow() {
    ...
    @Override
    public UtilizationDataRecord values(OffsetDateTime value1, OffsetDateTime value2, String value3, String value4, String value5, String value6, Double value7, Double value8, Double value9, Double value10, Double value11, Double value12, Double value13, Double value14, String value15, Double value16, Double value17, Double value18, Double value19, Double value20) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UtilizationDataRecord(OffsetDateTime starttime, OffsetDateTime endtime, String accountid, String settingid, String instanceid, String instancetype, Double maxcpu, Double maxmemory, Double avgcpu, Double avgmemory, Double maxcpuvalue, Double maxmemoryvalue, Double avgcpuvalue, Double avgmemoryvalue, String clusterid, Double avgstoragerequestvalue, Double avgstorageusagevalue, Double avgstoragecapacityvalue, Double maxstoragerequestvalue, Double maxstorageusagevalue) {
        super(UtilizationData.UTILIZATION_DATA);
