...
public class LogAnalysisServiceImpl implements LogAnalysisService {
  ...
  private LogAnalysisLearningEngineTask createLogCanaryAnalysisLearningEngineTask(AnalysisInput input) {
    ...
    if (preDeploymentTimeRange.isPresent()) {
      ...
      task.setAnalysisType(input.getLearningEngineTaskType());
    } else {
  ...
  private Set<String> getTestHosts(String verificationTaskId, Instant startTime, Instant endTime) {
    return hostRecordService.get(verificationTaskId, startTime, endTime);
  }
