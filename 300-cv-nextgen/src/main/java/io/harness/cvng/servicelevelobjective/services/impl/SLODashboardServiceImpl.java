...
public class SLODashboardServiceImpl implements SLODashboardService {
  ...
  public PageResponse<SLOConsumptionBreakdown> getSLOConsumptionBreakdownView(
    ...
    Map<SimpleSLODetails, Double> simpleSLODetailsToWeightPercentageMap =
        compositeServiceLevelObjective.getServiceLevelObjectivesDetails().stream().collect(Collectors.toMap(sloDetail
        ...
        sloHealthListViewPageResponse.getContent()
            ...
            .map(sloDetail
                -> getSLOConsumptionBreakdown(sloDetail, compositeServiceLevelObjective,
                    simpleSLODetailsToWeightPercentageMap, projectParams, startTime, endTime))
            .collect(Collectors.toList());
  ...
  private SLOConsumptionBreakdown getSLOConsumptionBreakdown(SLOHealthListView sloDetail,
      CompositeServiceLevelObjective compositeServiceLevelObjective,
      Map<SimpleSLODetails, Double> simpleSLODetailsToWeightPercentageMap, ProjectParams projectParams, Long startTime,
      Long endTime) {
    Double weightPercentage =
        simpleSLODetailsToWeightPercentageMap.get(SimpleSLODetails.builder()
    ...
    TimeRangeParams filter = TimeRangeParams.builder()
    ...
    ServiceLevelIndicator sli = serviceLevelIndicatorService.getServiceLevelIndicator(
    ...
    SLODashboardWidget.SLOGraphData sloGraphData =
        sliRecordService.getGraphData(sli, timePeriod.getStartTime(compositeServiceLevelObjective.getZoneOffset()),
            currentTimeMinute, sloDetail.getTotalErrorBudget(), sli.getSliMissingDataType(), sli.getVersion(), filter);
