...
public class ServiceLevelObjectiveV2DTO implements YamlDTO {
  @ApiModelProperty(required = true) @NotNull @EntityIdentifier ServiceLevelObjectiveType serviceLevelObjectiveType;
  ...
  @Valid List<CompositeServiceLevelObjective.ServiceLevelObjectivesDetail> serviceLevelObjectivesDetails;
