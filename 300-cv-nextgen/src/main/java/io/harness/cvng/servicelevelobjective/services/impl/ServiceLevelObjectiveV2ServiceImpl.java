...
public class ServiceLevelObjectiveV2ServiceImpl implements ServiceLevelObjectiveV2Service {
  ...
  private AbstractServiceLevelObjective updateSLOV2Entity(ProjectParams projectParams,
    ...
    UpdateOperations<AbstractServiceLevelObjective> updateOperations =
        hPersistence.createUpdateOperations(AbstractServiceLevelObjective.class);
    updateOperations.set(ServiceLevelObjectiveV2Keys.name, serviceLevelObjectiveV2DTO.getName());
    if (serviceLevelObjectiveV2DTO.getDescription() != null) {
      updateOperations.set(ServiceLevelObjectiveV2Keys.desc, serviceLevelObjectiveV2DTO.getDescription());
    }
    updateOperations.set(
        ServiceLevelObjectiveV2Keys.tags, TagMapper.convertToList(serviceLevelObjectiveV2DTO.getTags()));
    updateOperations.set(
        ServiceLevelObjectiveV2Keys.userJourneyIdentifiers, serviceLevelObjectiveV2DTO.getUserJourneyRefs());
    if (abstractServiceLevelObjective.getServiceLevelObjectiveType().equals(ServiceLevelObjectiveType.SIMPLE)) {
      ...
      updateOperations.set(
          SimpleServiceLevelObjectiveKeys.healthSourceIdentifier, serviceLevelObjectiveV2DTO.getHealthSourceRef());
      updateOperations.set(SimpleServiceLevelObjectiveKeys.serviceLevelIndicatorType,
    ...
    if (abstractServiceLevelObjective.getServiceLevelObjectiveType().equals(ServiceLevelObjectiveType.COMPOSITE)) {
    ...
    updateOperations.set(ServiceLevelObjectiveV2Keys.sloTargetPercentage,
        serviceLevelObjectiveV2DTO.getSloTarget().getSloTargetPercentage());
  ...
  private ServiceLevelObjectiveV2Response sloEntityToSLOResponse(AbstractServiceLevelObjective serviceLevelObjective) {
    ServiceLevelObjectiveV2DTO serviceLevelObjectiveDTO =
        serviceLevelObjectiveTypeSLOV2TransformerMap.get(serviceLevelObjective.getServiceLevelObjectiveType())
  ...
  private AbstractServiceLevelObjective saveServiceLevelObjectiveV2Entity(
    ...
    AbstractServiceLevelObjective serviceLevelObjectiveV2 =
        serviceLevelObjectiveTypeSLOV2TransformerMap.get(serviceLevelObjectiveV2DTO.getServiceLevelObjectiveType())
