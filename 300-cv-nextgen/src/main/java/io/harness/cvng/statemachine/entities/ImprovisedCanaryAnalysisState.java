...
@NoArgsConstructor
@Slf4j
public class ImprovisedCanaryAnalysisState extends TimeSeriesAnalysisState {
    ...
    @Override
    public AnalysisState.StateType getType() {
        return StateType.IMPROVED_CANARY_STATE;
    }
}
