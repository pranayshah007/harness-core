...
public class ImprovisedCanaryAnalysisStateExecutor extends TimeSeriesAnalysisStateExecutor<CanaryAnalysisState> {
    @Override
    ...
    protected List<String> scheduleAnalysis(AnalysisInput analysisInput) {
        return timeSeriesAnalysisService.scheduleImprovisedCanaryAnalysis(analysisInput);
    }
}
