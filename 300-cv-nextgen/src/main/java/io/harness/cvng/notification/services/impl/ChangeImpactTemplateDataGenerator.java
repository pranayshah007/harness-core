...
public class ChangeImpactTemplateDataGenerator
    extends NotificationRuleTemplateDataGenerator<MonitoredServiceChangeImpactCondition> {
  @Override
  public Map<String, String> getTemplateData(ProjectParams projectParams, String name, String identifier,
      String serviceIdentifier, MonitoredServiceChangeImpactCondition condition,
  ...
  private String getTriggerMessage(MonitoredServiceChangeImpactCondition condition) {
