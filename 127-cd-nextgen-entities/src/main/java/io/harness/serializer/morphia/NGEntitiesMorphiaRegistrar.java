...
import io.harness.cdng.infra.yaml.AzureWebAppInfraMapping;
import io.harness.cdng.infra.yaml.CustomDeploymentInfraMapping;
import io.harness.cdng.infra.yaml.EcsInfraMapping;
import io.harness.cdng.infra.yaml.ElastigroupInfraMapping;
import io.harness.cdng.infra.yaml.InfraMapping;
import io.harness.cdng.infra.yaml.K8sAzureInfraMapping;
import io.harness.cdng.infra.yaml.K8sDirectInfraMapping;
import io.harness.cdng.infra.yaml.K8sGcpInfraMapping;
import io.harness.cdng.infra.yaml.PdcInfraMapping;
import io.harness.cdng.infra.yaml.ServerlessAwsLambdaInfraMapping;
import io.harness.cdng.infra.yaml.SshWinRmAwsInfraMapping;
import io.harness.cdng.infra.yaml.SshWinRmAzureInfraMapping;
