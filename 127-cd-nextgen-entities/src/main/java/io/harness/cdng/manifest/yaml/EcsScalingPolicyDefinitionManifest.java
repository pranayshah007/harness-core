...
@RecasterAlias("io.harness.cdng.manifest.yaml.EcsScalingPolicyDefinitionManifest")
public class EcsScalingPolicyDefinitionManifest implements ManifestAttributes, Visitable {
  ...
  public ManifestAttributes applyOverrides(ManifestAttributes overrideConfig) {
    ...
    if (ecsScalingPolicyDefinitionManifest.getStore() != null
        && ecsScalingPolicyDefinitionManifest.getStore().getValue() != null) {
