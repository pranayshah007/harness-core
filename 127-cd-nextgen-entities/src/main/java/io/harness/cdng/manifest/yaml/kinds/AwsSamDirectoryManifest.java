...
import io.harness.cdng.visitor.helpers.manifest.AwsSamDirectoryManifestVisitorHelper;
...
@SimpleVisitorHelper(helperClass = AwsSamDirectoryManifestVisitorHelper.class)
@TypeAlias("AwsSamDirectoryManifest")
@RecasterAlias("io.harness.cdng.manifest.yaml.kinds.AwsSamDirectoryManifest")
public class AwsSamDirectoryManifest implements ManifestAttributes, Visitable {
  ...
  public String getKind() {
    return ManifestType.AwsSamDirectory;
  }
  ...
  public ManifestAttributes applyOverrides(ManifestAttributes overrideConfig) {
    AwsSamDirectoryManifest awsSamDirectoryManifest = (AwsSamDirectoryManifest) overrideConfig;
    AwsSamDirectoryManifest resultantManifest = this;
    if (awsSamDirectoryManifest.getStore() != null && awsSamDirectoryManifest.getStore().getValue() != null) {
