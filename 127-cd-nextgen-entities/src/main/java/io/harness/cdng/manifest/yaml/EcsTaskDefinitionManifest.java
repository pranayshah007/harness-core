...
@RecasterAlias("io.harness.cdng.manifest.yaml.EcsTaskDefinitionManifest")
public class EcsTaskDefinitionManifest implements ManifestAttributes, Visitable {
  ...
  public ManifestAttributes applyOverrides(ManifestAttributes overrideConfig) {
    EcsTaskDefinitionManifest ecsTaskDefinitionManifest = (EcsTaskDefinitionManifest) overrideConfig;
