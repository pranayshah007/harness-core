...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = ValuesManifestOutcome.class, name = ManifestType.VALUES),
      ...
      @JsonSubTypes.Type(value = VarsManifestOutcome.class, name = ManifestType.VARS),
      @JsonSubTypes.Type(value = AutoScalerManifestOutcome.class, name = ManifestType.AUTOSCALER),
})
