...
@JsonSubTypes({
  ...
  , @JsonSubTypes.Type(value = ValuesManifestOutcome.class, name = ManifestType.VALUES),
      ...
      @JsonSubTypes.Type(value = EcsScalableTargetDefinitionManifestOutcome.class, name = ManifestType.EcsScalableTargetDefinition),
      @JsonSubTypes.Type(value = EcsScalingPolicyDefinitionManifestOutcome.class, name = ManifestType.EcsScalingPolicyDefinition),
