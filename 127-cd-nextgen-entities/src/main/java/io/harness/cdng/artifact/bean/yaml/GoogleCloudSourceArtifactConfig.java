...
public class GoogleCloudSourceArtifactConfig implements ArtifactConfig, Visitable, WithConnectorRef {
     ...
     */
    @NotNull @ApiModelProperty(dataType = SwaggerConstants.STRING_CLASSPATH) @Wither ParameterField<String> sourceDirectory;
    /**
    ...
    public ArtifactConfig applyOverrides(ArtifactConfig overrideConfig) {
        GoogleCloudSourceArtifactConfig googleCloudSourceArtifactConfig =
                (GoogleCloudSourceArtifactConfig) overrideConfig;
