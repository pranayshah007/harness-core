...
@Value
@Builder
@SimpleVisitorHelper(helperClass = ApplicationSettingsConfigurationVisitorHelper.class)
@TypeAlias("applicationSettingsConfiguration")
@RecasterAlias("io.harness.cdng.azure.config.yaml.ApplicationSettingsConfiguration")
