...
public enum ExecutionNodeType {
  ...
  AWS_SAM_PUBLISH("AWS_SAM_PUBLISH", YamlTypes.AWS_SAM_PUBLISH),
  AWS_SAM_VALIDATE_BUILD_PACKAGE("AWS_SAM_VALIDATE_BUILD_PACKAGE", YamlTypes.AWS_SAM_VALIDATE_BUILD_PACKAGE);
