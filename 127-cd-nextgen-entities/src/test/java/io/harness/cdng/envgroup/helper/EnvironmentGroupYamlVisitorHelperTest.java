...
public class EnvironmentGroupYamlVisitorHelperTest extends CategoryTest {
  ...
  public void testAddReference() {
    ...
    EnvironmentGroupYaml environmentGroupYaml = EnvironmentGroupYaml.builder().envGroupRef(ParameterField.createValueField("ref")).build();
    ...
    environmentGroupYaml = EnvironmentGroupYaml.builder().envGroupRef(ParameterField.createExpressionField(true, "<+b>", null, false)).build();
     entityDetailProtoDTOS =
            envGroupVisitor.addReference(environmentGroupYaml, accountId, orgId, projectId, contextMap);
    assertThat(entityDetailProtoDTOS).hasSize(1);
