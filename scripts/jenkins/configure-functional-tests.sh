...
replace_text "uri: mongodb://localhost:27017/harnessci" "uri: ${MONGO_URI}_ci" ci-manager/config/ci-manager-config.yml
replace_text "uri: mongodb://localhost:27017/harness" "uri: ${MONGO_URI}" ci-manager/config/ci-manager-config.yml

CONFIG_FILES=(360-cg-manager/config.yml 350-event-server/event-service-config.yml 280-batch-processing/batch-processing-config.yml 210-command-library-server/command-library-server-config.yml ci-manager/config/ci-manager-config.yml)
