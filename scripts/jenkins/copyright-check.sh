...
EXCLUSION_LIST='\.pem\|\.mod\|\.sum\|\.log\|\.toml\|\.yml\|\.yaml\|\.tpl\|\.lock\|\.tgz\|\.properties\|\.md\|\.json\|\.config\|\.env\|\.txt\|\.info\|\.jks\|\.mod\|\.env\|\.xml\|\.jfc\|\.MD\|\.factories\|project/bazelproject\|scripts/jenkins/bazelignore\|resources/mockito-extensions\|\.bazelignore\|\.datacollection\|\.tf\|\.ftl\|\.gitignore\|^\.'
