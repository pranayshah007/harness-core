...
if [ $1 == "core" ]; then
  ...
  bazel ${bazelrc} build //delegate/src/main/java/io/harness/delegate/runner:DelegateRunner_deploy.jar ${BAZEL_ARGUMENTS}
  cp ${BAZEL_DIRS}/bin/delegate/src/main/java/io/harness/delegate/runner/DelegateRunner_deploy.jar ./dockerization/delegate/runner.jar
else
  if [ $1 == "immutable" ]; then
