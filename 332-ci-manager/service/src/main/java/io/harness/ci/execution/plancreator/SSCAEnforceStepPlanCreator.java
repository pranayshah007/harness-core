...
public class SSCAEnforceStepPlanCreator extends CIPMSStepPlanCreatorV2<SSCAEnforceStepNode> {
    @Override
    ...
    @Override
    public PlanCreationResponse createPlanForField(PlanCreationContext ctx, SSCAEnforceStepNode stepElement) {
