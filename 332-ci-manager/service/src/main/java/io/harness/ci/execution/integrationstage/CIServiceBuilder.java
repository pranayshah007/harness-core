...
public class CIServiceBuilder {
  ...
  public static List<ContainerDefinitionInfo> createServicesContainerDefinition(IntegrationStageNode stageElementConfig,
  ...
  public static List<String> getServiceIdList(IntegrationStageNode stageElementConfig) {
  ...
  public static List<Integer> getServiceGrpcPortList(IntegrationStageNode stageElementConfig) {
