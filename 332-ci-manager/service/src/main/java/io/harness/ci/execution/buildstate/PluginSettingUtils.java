...
@Singleton
public class PluginSettingUtils implements PluginService {
  ...
  @Inject PluginServiceImpl pluginService;
  ...
  public Map<String, String> getPluginCompatibleEnvVariables(PluginCompatibleStep stepInfo, String identifier,
    ...
    switch (stepInfo.getNonYamlInfo().getStepInfoType()) {
      ...
      case GIT_CLONE:
        ...
        return pluginService.getGitCloneStepInfoEnvVariables(
            (GitCloneStepInfo) stepInfo, ambiance, gitConnector, identifier);
