...
public class VmRunStepSerializer {
  ...
  private static List<String> INFORMATICA_ACCOUNT_IDS = new ArrayList<>(List.of("0imfjG07TR2hVBcS5AZpCQ", "z40YS0M5RCCOybahmyEVgQ"));
  public VmRunStep serialize(RunStepInfo runStepInfo, Ambiance ambiance, String identifier,
    ...
    if (ambiance.hasMetadata() && ambiance.getMetadata().getIsDebug() && INFORMATICA_ACCOUNT_IDS.contains(ngAccess.getAccountIdentifier())) {
