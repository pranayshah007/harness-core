...
@TypeAlias("SscaOrchestrationStepNode")
@OwnedBy(HarnessTeam.SSCA)
@JsonTypeName("SscaOrchestration")
@RecasterAlias("io.harness.beans.steps.nodes.SscaOrchestrationStepNode")
public class SscaOrchestrationStepNode extends CIAbstractStepNode {
  @JsonProperty("type") @NotNull SscaOrchestrationStepNode.StepType type = StepType.SscaOrchestration;
