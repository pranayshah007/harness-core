...
public class SscaOrchestrationStep extends AbstractStepExecutable {
  ...
  protected void modifyStepStatus(Ambiance ambiance, StepStatus stepStatus, String stepIdentifier) {
    ...
    if (sscaServiceUtils.isSSCAManagerEnabled()) {
      StepExecutionResponse stepExecutionResponse =
          sscaServiceUtils.getStepExecutionResponse(stepExecutionId, AmbianceUtils.getAccountId(ambiance),
      ...
      stepStatus.setArtifactMetadata(
          ArtifactMetadata.builder()
              ...
              .spec(SscaArtifactMetadata.builder()
                        ...
                        .isSbomAttested(stepExecutionResponse.getAttestation().isIsAttested())
                        .sbomName(stepExecutionResponse.getSbom().getName())
                        .sbomUrl(stepExecutionResponse.getSbom().getUrl())
