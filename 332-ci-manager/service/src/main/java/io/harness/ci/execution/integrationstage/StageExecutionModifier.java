...
public interface StageExecutionModifier {
   ...
   * @param stageConfig IntegrationStageNode object that holds info
   * @return modified execution
   */
  ExecutionElementConfig modifyExecutionPlan(ExecutionElementConfig execution, IntegrationStageNode stageConfig,
