...
@TypeAlias("SSCAOrchestrateStepInfo")
@OwnedBy(CI)
@RecasterAlias("io.harness.beans.steps.stepinfo.SSCAOrchestrateStepInfo")
public class SSCAOrchestrateStepInfo implements PluginCompatibleStep,WithConnectorRef {
    ...
    @JsonIgnore
    public static final TypeInfo typeInfo = TypeInfo.builder().stepInfoType(CIStepInfoType.SSCAOrchestrate).build();

    @JsonIgnore
    public static final StepType STEP_TYPE = StepType.newBuilder()
            .setType(CIStepInfoType.SSCAOrchestrate.getDisplayName())
    ...
    public SSCAOrchestrateStepInfo(String identifier, String name, Integer retry, ParameterField<Map<String, JsonNode>> settings,
