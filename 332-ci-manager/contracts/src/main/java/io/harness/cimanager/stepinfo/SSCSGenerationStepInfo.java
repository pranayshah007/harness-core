...
@TypeAlias("SSCSGenerationStepInfo")
@OwnedBy(CI)
@RecasterAlias("io.harness.beans.steps.stepinfo.SSCSGenerationStepInfo")
public class SSCSGenerationStepInfo implements PluginCompatibleStep,WithConnectorRef {
    ...
    @JsonIgnore
    public static final TypeInfo typeInfo = TypeInfo.builder().stepInfoType(CIStepInfoType.SSCSGeneration).build();

    @JsonIgnore
    public static final StepType STEP_TYPE = StepType.newBuilder()
            .setType(CIStepInfoType.SSCSGeneration.getDisplayName())
    ...
    public SSCSGenerationStepInfo(String identifier, String name, Integer retry, ParameterField<Map<String, JsonNode>> settings,
