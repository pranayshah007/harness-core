...
@OwnedBy(STO)
@RecasterAlias("io.harness.beans.steps.stepinfo.BanditStepInfo")
public class BanditStepInfo implements PluginCompatibleStep {
  ...
  public BanditStepInfo(String identifier, String name, Integer retry, ParameterField<Map<String, JsonNode>> settings,
