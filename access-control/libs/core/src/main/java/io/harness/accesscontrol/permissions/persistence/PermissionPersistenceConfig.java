...
@Configuration
@EnableMongoRepositories(basePackages = {"io.harness.accesscontrol.permissions.persistence"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class))
@EnableMongoAuditing
public class PermissionPersistenceConfig extends AbstractMongoClientConfiguration {
  private final MongoConfig mongoBackendConfiguration;

  @Inject
  public PermissionPersistenceConfig(Injector injector) {
