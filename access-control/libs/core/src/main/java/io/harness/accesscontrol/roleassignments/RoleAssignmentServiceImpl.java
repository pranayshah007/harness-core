...
import io.harness.accesscontrol.publicaccess.PublicAccessUtil;
...
public class RoleAssignmentServiceImpl implements RoleAssignmentService {
  ...
  public RoleAssignment create(RoleAssignment roleAssignment) {
    ...
    if (!PublicAccessUtil.isPrincipalPublic(roleAssignment.getPrincipalIdentifier())
    ...
    if (!PublicAccessUtil.isResourceGroupPublic(roleAssignment.getResourceGroupIdentifier())
