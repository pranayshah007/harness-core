...
public class DebeziumConfig {
  ...
  /**
   * The name of the Java class for the ConnectorDisconnectHandler. Always use a value of io.debezium.ConnectorDisconnectHandler.mongodb.MongoDbConnector
   * for the MongoDB ConnectorDisconnectHandler.
   */
  @JsonProperty("ConnectorDisconnectHandler.class") private String connectorClass;
  /**
   ...
   *
   ...
   The ConnectorDisconnectHandler will read the collection contents in multiple batches of this size. Defaults to 0, which indicates that
   ...
   * that should be processed during each iteration of this ConnectorDisconnectHandler.
   */
