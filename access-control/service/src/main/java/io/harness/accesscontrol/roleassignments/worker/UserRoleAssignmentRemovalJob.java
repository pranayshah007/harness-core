...
public class UserRoleAssignmentRemovalJob implements Runnable {
  ...
  private void execute() {
    ...
    List<String> targetAccounts = filterAccountsForFFEnabled(ngEnabledAccounts);
  ...
  private List<String> filterAccountsWhereDefaultUserGroupDoesntHaveViewerRoleAssignment(List<String> accountIds) {
