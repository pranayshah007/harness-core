...
@Slf4j
public class AccountRoleAssignmentsApiImpl implements AccountRoleAssignmentsApi {
  ...
  @Inject
  public AccountRoleAssignmentsApiImpl(RoleAssignmentApiUtils roleAssignmentApiUtils,
  ...
  @Override
  public Response createAccountScopedRoleAssignments(RoleAssignment request, String harnessAccount) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(harnessAccount).build();
  ...
  @Override
  public Response deleteAccountScopedRoleAssignment(String roleassignment, String harnessAccount) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(harnessAccount).build();
  ...
  @Override
  public Response getAccountScopedRoleAssignment(String roleassignment, String harnessAccount) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(harnessAccount).build();
    Scope scope = fromParams(harnessScopeParams);
    io.harness.accesscontrol.roleassignments.RoleAssignment roleAssignment =
  ...
  @Override
  public Response getAccountScopedRoleAssignments(
      String harnessAccount, Integer page, Integer limit, String sort, String order) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(harnessAccount).build();
    String scopeIdentifier = fromParams(harnessScopeParams).toString();
