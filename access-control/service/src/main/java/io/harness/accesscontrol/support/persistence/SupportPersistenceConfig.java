...
@Configuration
@EnableMongoRepositories(basePackages = {"io.harness.accesscontrol.support.persistence"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class))
@OwnedBy(HarnessTeam.PL)
public class SupportPersistenceConfig extends AbstractMongoClientConfiguration {
  private final MongoConfig mongoBackendConfiguration;

  @Inject
  public SupportPersistenceConfig(Injector injector) {
