...
@Slf4j
public class ProjectRoleAssignmentsApiImpl implements ProjectRoleAssignmentsApi {
  ...
  @Inject
  public ProjectRoleAssignmentsApiImpl(RoleAssignmentApiUtils roleAssignmentApiUtils,
  ...
  @Override
  public Response deleteProjectScopedRoleAssignment(
      String roleassignment, String org, String project, String harnessAccount) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder()
                                                .accountIdentifier(harnessAccount)
                                                .orgIdentifier(org)
                                                .projectIdentifier(project)
  ...
  @Override
  public Response getProjectScopedRoleAssignment(
      String roleassignment, String org, String project, String harnessAccount) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder()
                                                .accountIdentifier(harnessAccount)
                                                .orgIdentifier(org)
  ...
  @Override
  public Response getProjectScopedRoleAssignments(
      String org, String project, String harnessAccount, Integer page, Integer limit, String sort, String order) {
    HarnessScopeParams harnessScopeParams = HarnessScopeParams.builder()
                                                .accountIdentifier(harnessAccount)
                                                .orgIdentifier(org)
                                                .projectIdentifier(project)
