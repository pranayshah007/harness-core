...
@OwnedBy(PL)
public class OrgRoleAssignmentsApiImplTest extends AccessControlTestBase {
  ...
  private OrgRoleAssignmentsApiImpl orgRoleAssignmentsApi;
  ...
  public void setup() {
    ...
    orgRoleAssignmentsApi = spy(new OrgRoleAssignmentsApiImpl(roleAssignmentApiUtils, roleAssignmentService,
    ...
    harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(account).orgIdentifier(org).build();
  ...
  public void testCreate() {
    ...
    orgRoleAssignmentsApi.createOrgScopedRoleAssignments(request, org, account);
  ...
  public void testGetList() {
    ...
    Response accountScopedRoleAssignments = orgRoleAssignmentsApi.getOrgScopedRoleAssignments(
        org, account, pageRequest.getPageIndex(), pageRequest.getPageSize(), "created", "DESC");
  ...
  public void testGet() {
    ...
    Response accountScopedRoleAssignments =
        orgRoleAssignmentsApi.getOrgScopedRoleAssignment(roleAssignment.getIdentifier(), org, account);
