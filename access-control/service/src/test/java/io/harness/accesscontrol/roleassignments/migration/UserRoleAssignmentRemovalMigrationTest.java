...
public class UserRoleAssignmentRemovalMigrationTest extends AccessControlTestBase {
    ...
    public void setup(){
        ...
        userRoleAssignmentRemovalMigration = new UserRoleAssignmentRemovalMigration(roleAssignmentRepository, featureFlagHelperService, accountClient, scopeService);
    }

    @Test
    @Owner(developers = JIMIT_GANDHI)
    @Category(UnitTests.class)
    public void testMigrateAccounts_WhenAccountScopeUserGroupRoleAssignmentDoesNotExist_ThenSkipsDeletingAccountScopeUserRoleAssignment(){
        ...
        RoleAssignmentDBO accountScopeUserRoleAssignment = createAccountScopeUserRoleAssignment(accountIdentifier, PrincipalType.USER, principalIdentifier);
        roleAssignmentRepository.save(accountScopeUserRoleAssignment);
        RoleAssignmentDBO orgScopeUserRoleAssignment = createOrganizationScopeUserRoleAssignment(accountIdentifier, orgIdentifier);
        roleAssignmentRepository.save(orgScopeUserRoleAssignment);
        RoleAssignmentDBO projectScopeUserRoleAssignment = createProjectScopeUserRoleAssignment(accountIdentifier, orgIdentifier, projectIdentifier);
    ...
    private RoleAssignmentDBO createAccountScopeUserRoleAssignment(String accountIdentifier, PrincipalType principalType, String principalIdentifier) {
    ...
    private RoleAssignmentDBO createProjectScopeUserRoleAssignment(String accountIdentifier, String orgIdentifier, String projectIdentifier) {
        Scope scope = ScopeMapper.fromDTO(ScopeDTO.builder()
                .accountIdentifier(accountIdentifier)
                .orgIdentifier(orgIdentifier)
