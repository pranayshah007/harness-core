...
@OwnedBy(PL)
public class AccountRoleAssignmentsApiImplTest extends AccessControlTestBase {
  ...
  private AccountRoleAssignmentsApiImpl accountRoleAssignmentsApi;
  ...
  public void setup() {
    ...
    accountRoleAssignmentsApi = spy(new AccountRoleAssignmentsApiImpl(roleAssignmentApiUtils, roleAssignmentService,
    ...
    harnessScopeParams = HarnessScopeParams.builder().accountIdentifier(account).build();
  ...
  public void testGetList() {
    ...
    Response accountScopedRoleAssignments = accountRoleAssignmentsApi.getAccountScopedRoleAssignments(
        account, pageRequest.getPageIndex(), pageRequest.getPageSize(), "created", "DESC");
  ...
  public void testGet() {
    ...
    Response accountScopedRoleAssignments =
        accountRoleAssignmentsApi.getAccountScopedRoleAssignment(roleAssignment.getIdentifier(), account);
