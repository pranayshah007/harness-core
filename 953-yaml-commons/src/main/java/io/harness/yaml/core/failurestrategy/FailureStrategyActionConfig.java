...
import io.harness.yaml.core.failurestrategy.markFailure.MarkAsFailure_FailureActionConfig;
...
@JsonSubTypes({
  ...
  , @Type(value = IgnoreFailureActionConfig.class, name = NGFailureActionTypeConstants.IGNORE),
      ...
      @Type(value = MarkAsFailure_FailureActionConfig.class, name = NGFailureActionTypeConstants.MARK_AS_FAILURE),
})
