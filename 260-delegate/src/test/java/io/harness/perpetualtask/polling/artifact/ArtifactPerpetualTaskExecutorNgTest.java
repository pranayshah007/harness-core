...
public class ArtifactPerpetualTaskExecutorNgTest extends DelegateTestBase {
  ...
  public void setup() {
    ...
    artifactPerpetualTaskExecutorNg =
        new ArtifactPerpetualTaskExecutorNg(kryoSerializerWrapper, artifactRepositoryService, pollingResponsePublisher);
  ...
  private PerpetualTaskResponse runOnce(int startIndex, int endIndex, boolean throwErrorWhileCollection,
    ...
    ArtifactCollectionTaskParamsNg taskParams =
        ArtifactCollectionTaskParamsNg.newBuilder()
            ...
            .setArtifactCollectionParams(ByteString.copyFrom(kryoSerializerWrapper.asBytes(artifactTaskParameters)))
            .build();
