...
public class ContainerFactory {
  ...
  public V1ContainerBuilder createContainer(final K8SInfra k8SInfra, final K8SStep step, final int port) {
    ...
    var envVars = containerRuntime.getEnvMap();
    envVars.put(HARNESS_ACCOUNT_ID_VARIABLE, "kmpySmUISimoRrJL6NL73w"); // TODO get it
    envVars.put(HARNESS_LOG_PREFIX, k8SInfra.getLogPrefix());
    envVars.put(HARNESS_LOG_SERVICE_ENDPOINT, k8SInfra.getLogServiceEndpoint());
    envVars.put(HARNESS_LOG_SERVICE_TOKEN, k8SInfra.getLogToken());
    envVars.put(DELEGATE_TOKEN, "2f6b0988b6fb3370073c3d0505baee59"); // TODO get it
    ...
    final V1ContainerBuilder containerBuilder = new V1ContainerBuilder()
                                                    ...
                                                    .withEnv(K8SEnvVar.fromMap(envVars))
