...
public class AcquireTaskHelper {
  ...
  public DelegateTaskPackage acquireKryo(final String accountId, final String delegateId,
      final String delegateInstanceId, final String taskId, Consumer<Response<DelegateTaskPackage>> handler)
      throws IOException {
    if (currentlyAcquiringTasks.contains(taskId)) {
