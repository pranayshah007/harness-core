...
public class DelegatePlatformApplication extends Application<DelegatePlatformConfig> {
  ...
  public DelegatePlatformApplication(final String configFileName) throws IOException {
  ...
  public static void main(final String... args) throws Exception {
    new DelegatePlatformApplication(args[1]).run(args);
  }
  ...
  public void run(final DelegatePlatformConfig delegateAgentConfig, final Environment environment) throws Exception {
    ...
    final Injector injector = Guice.createInjector(new DelegatePlatformModule(configuration));
  ...
  @Override
  public void initialize(final Bootstrap<DelegatePlatformConfig> bootstrap) {
