...
public class DisableBuiltInSMValidator implements SettingValidator {
    ...
    try {
      ...
      if (connectorResponseDTOList.size() < 2) {
        throw new InvalidRequestException(String.format(
            "Cannot disable BuiltIn Harness Secrets Manager as there is not other Secret Manager present in the account"));
      }
    } catch (IOException e) {
