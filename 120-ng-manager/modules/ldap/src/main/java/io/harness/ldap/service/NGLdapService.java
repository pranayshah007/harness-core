...
public interface NGLdapService {
  LdapTestResponse validateLdapConnectionSettings(@NotNull String accountIdentifier, String orgIdentifier,
      String projectIdentifier, software.wings.beans.sso.LdapSettings settings);
  LdapTestResponse validateLdapUserSettings(
          @NotNull String accountIdentifier, String orgIdentifier, String projectIdentifier, software.wings.beans.sso.LdapSettings settings);
