...
public class NGLdapServiceImpl implements NGLdapService {
  ...
  public static final int LDAP_TASK_DEFAULT_TIMEOUT = 60000;
  ...
  private DelegateResponseData getDelegateResponseData(String accountIdentifier, String orgIdentifier,
    ...
    DelegateTaskRequest delegateTaskRequest =
        DelegateTaskRequest.builder()
            ...
            .executionTimeout(Duration.ofMillis(Math.max(LDAP_TASK_DEFAULT_TIMEOUT,ldapSettings.getConnectionSettings().getResponseTimeout()))
