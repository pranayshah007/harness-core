...
public class OrgFavoriteApiImpl implements OrgFavoritesApi {
  ...
  @Override
  public Response createOrgFavorite(String org, @NotNull String userId, @NotNull String moduleType,
    ...
    FavoriteResponse favoriteResponse = favoritesResourceUtils.toFavoriteResponse(favoriteService.createFavorite(
        harnessAccount, org, null, userId, EnumUtils.getEnum(ModuleType.class, moduleType),
