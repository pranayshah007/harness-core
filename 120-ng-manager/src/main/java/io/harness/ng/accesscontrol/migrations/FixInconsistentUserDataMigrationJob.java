...
import io.harness.ng.accesscontrol.migrations.services.FixInconsistentUserDataMigrationService;
...
public class FixInconsistentUserDataMigrationJob implements Managed {
  ...
  public void start() throws Exception {
    ...
    defaultUserGroupJobFuture = executorService.scheduleWithFixedDelay(migrationService, 1, 2, TimeUnit.MINUTES);
  }
