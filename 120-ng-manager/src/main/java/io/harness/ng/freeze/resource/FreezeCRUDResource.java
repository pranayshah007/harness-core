...
public class FreezeCRUDResource {
  ...
  //@NGAccessControlCheck(resourceType = DEPLOYMENTFREEZE, permission =
  //PermissionTypes.DEPLOYMENT_FREEZE_CREATE_PERMISSION)
  ...
  //@NGAccessControlCheck(resourceType = DEPLOYMENTFREEZE, permission =
  //PermissionTypes.DEPLOYMENT_FREEZE_GLOBAL_PERMISSION)
