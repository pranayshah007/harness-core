...
import static io.harness.beans.FeatureName.TAS_POST_PROD_ROLLBACK;
...
public class PostProdRollbackServiceImpl implements PostProdRollbackService {
  ...
  private static final Map<InstanceType, FeatureName> INSTANCE_TYPE_TO_FF_MAP =
      Map.of(InstanceType.K8S_INSTANCE, POST_PROD_ROLLBACK, InstanceType.TAS_INSTANCE, TAS_POST_PROD_ROLLBACK);
