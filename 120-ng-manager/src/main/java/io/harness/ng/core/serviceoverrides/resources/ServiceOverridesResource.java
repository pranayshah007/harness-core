...
public class ServiceOverridesResource {
  ...
  create(@Parameter(description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @NotNull @QueryParam(
      ...
      @RequestBody(required = true, description = "Details of the Service Override to be created", content = {
        @Content(examples = @ExampleObject(name = "Create", summary = "Sample Service Override create payload",
                     value = DocumentationConstants.serviceOverrideRequestDTOV2,
                     description = "Sample Service Override payload"))
      }) @NonNull @Valid ServiceOverrideRequestDTOV2 requestDTOV2) {
  ...
  update(@Parameter(description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @NotNull @QueryParam(
      ...
      @RequestBody(required = true, description = "Details of the Service Override to be updated", content = {
        @Content(examples = @ExampleObject(name = "Update", summary = "Sample Service Override update payload",
                     value = DocumentationConstants.serviceOverrideRequestDTOV2,
                     description = "Sample Service Override payload"))
  ...
  upsert(@Parameter(description = NGCommonEntityConstants.ACCOUNT_PARAM_MESSAGE) @NotNull @QueryParam(
             NGCommonEntityConstants.ACCOUNT_KEY) String accountId,
      @RequestBody(required = true, description = "Details of the Service Override to be upserted", content = {
        @Content(examples = @ExampleObject(name = "Upsert", summary = "Sample Service Override upsert payload",
                     value = DocumentationConstants.serviceOverrideRequestDTOV2,
                     description = "Sample Service Override payload"))
      }) @Valid ServiceOverrideRequestDTOV2 requestDTOV2) {
    overrideValidatorService.validateRequestOrThrow(requestDTOV2, accountId);
