...
import io.harness.ng.core.migration.timescale.PopulateRollbackDurationToServiceInfraInfoTable;
...
public class NGCoreTimeScaleMigrationDetails implements MigrationDetails {
  ...
  public List<Pair<Integer, Class<? extends NGMigration>>> getMigrations() {
    return new ImmutableList.Builder<Pair<Integer, Class<? extends NGMigration>>>()
        ...
        .add(Pair.of(2, PopulateRollbackDurationToServiceInfraInfoTable.class))
        .build();
  }
}
