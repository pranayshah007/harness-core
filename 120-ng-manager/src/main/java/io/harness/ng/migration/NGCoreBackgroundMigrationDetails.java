...
import io.harness.ng.core.migration.background.FetchServicesWithIdentifierDissimilarityMigration;
...
public class NGCoreBackgroundMigrationDetails implements MigrationDetails {
  ...
  public List<Pair<Integer, Class<? extends NGMigration>>> getMigrations() {
    return new ImmutableList.Builder<Pair<Integer, Class<? extends NGMigration>>>()
        ...
        .add(Pair.of(5, FetchServicesWithIdentifierDissimilarityMigration.class))
        .build();
  }
}
