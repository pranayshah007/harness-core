...
public class ModuleLicensesSnapshotRedisEventConsumer extends DebeziumAbstractRedisConsumer {
  @Inject
  public ModuleLicensesSnapshotRedisEventConsumer(
      @Named(MODULE_LICENSES_SNAPSHOT_REDIS_EVENT_CONSUMER) Consumer redisConsumer, QueueController queueController,
      ModuleLicensesChangeEventHandler eventHandler, @Named("debeziumEventsCache") Cache<String, Long> eventsCache) {
