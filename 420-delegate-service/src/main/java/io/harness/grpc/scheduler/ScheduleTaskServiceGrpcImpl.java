...
public class ScheduleTaskServiceGrpcImpl extends ScheduleTaskServiceImplBase {
  ...
  private CleanupInfraResponse sendCleanupTask(final String accountId, final String infraRefId) {
    ...
    final var task = DelegateTask.builder()
                         .uuid(taskId)
  ...
  private static DelegateTask.DelegateTaskBuilder buildDelegateTask(final String accountId,
      final SchedulingConfig config, final EventType eventType, final String infraRefId, final String taskId) {
