...
public class InstanceSyncServiceImpl implements InstanceSyncService {
  ...
  public void processInstanceSyncForNewDeployment(DeploymentEvent deploymentEvent) {
    ...
    String infraIdentifier = deploymentEvent.getInfrastructureOutcome().getInfraIdentifier();
    String infraName = deploymentEvent.getInfrastructureOutcome().getInfraName();
