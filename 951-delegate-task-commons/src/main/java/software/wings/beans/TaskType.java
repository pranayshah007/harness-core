...
public enum TaskType {
  ...
  VALIDATE_TAS_CONNECTOR_TASK_NG(TaskGroup.TAS, "Tas ConnectorDisconnectHandler validation task"),
  ...
  RANCHER_TEST_CONNECTION_TASK_NG(TaskGroup.K8S_NG, "Rancher ConnectorDisconnectHandler test connection task for NG"),
