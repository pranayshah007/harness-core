...
public class GitHubApiClient {
  ...
  public List<Commit> listCommits(String owner, String repo, String apiToken, String sha, int pageCount) throws IOException {
    String url = String.format("%s/repos/%s/%s/commits?page=%d&per_page=100&sha=%s", BASE_URL, owner, repo, pageCount, sha);
