...
http_archive(
    ...
    url = "http://harness-artifactory.harness.io/artifactory/bazel-buildtools-github/archive/refs/tags/4.0.1.zip",
)
...
http_archive(
    ...
    urls = [
        "http://harness-artifactory.harness.io/artifactory/protobuf-github/archive/v3.15.0.tar.gz",
...
http_archive(
    ...
    urls = [
        "http://harness-artifactory.harness.io/artifactory/rules-go-github/download/v0.37.0/rules_go-v0.37.0.zip",
...
http_archive(
    ...
    urls = [
        "http://harness-artifactory.harness.io/artifactory/bazel-gazelle-github/download/v0.28.0/bazel-gazelle-v0.28.0.tar.gz",
...
http_archive(
    ...
    urls = [
        ...
        "http://harness-artifactory.harness.io/artifactory/rules-rust-github/archive/f37b9d6a552e9412285e627f30cb124e709f4f7a.tar.gz",
    ],
)
...
http_archive(
    ...
    urls = ["http://harness-artifactory.harness.io/artifactory/rules-proto-grpc-github/archive/1.0.2.tar.gz"],
)
...
http_archive(
    ...
    urls = [
        "http://harness-artifactory.harness.io/artifactory/rules-spring-github/download/2.1.4/rules-spring-2.1.4.zip",
    ],
)
...
http_archive(
    ...
    url = "http://harness-artifactory.harness.io/artifactory/rules-jvm-external-github/archive/%s.zip" % RULES_JVM_EXTERNAL_TAG,
)
...
maven_install(
    ...
    repositories = [
        "http://harness-artifactory.harness.io/artifactory/portal-maven",
...
""",
    ...
    urls = ["http://harness-artifactory.harness.io/artifactory/adoptjdk8u242-b08-github/download/jdk8u242-b08/OpenJDK8U-jdk_x64_linux_hotspot_8u242b08.tar.gz"],
)
...
""",
    ...
    strip_prefix = "jdk8u242-b08",
    urls = ["http://harness-artifactory.harness.io/artifactory/adoptjdk8u242-b08-github/download/jdk8u242-b08/OpenJDK8U-jdk_x64_mac_hotspot_8u242b08.tar.gz"],
)
...
http_archive(
    ...
    urls = ["http://harness-artifactory.harness.io/artifactory/rules-docker-github/download/v0.17.0/rules_docker-v0.17.0.tar.gz"],
)
...
http_archive(
    ...
    urls = [
        "http://harness-artifactory.harness.io/artifactory/rules-pkg-github/download/0.4.0/rules_pkg-0.4.0.tar.gz",
...
http_archive(
    ...
    url = "http://harness-artifactory.harness.io/artifactory/bazel-contrib-rules-jvm/archive/v0.4.0.tar.gz",
)
