...
go_repository(
    ...
    sum = "h1:fI9/5BDEaAv/pv1VO1X1n3jfP9it+IGqWsCuuBQI8wM=",
    version = "v1.11.67",
)
...
go_repository(
    ...
    sum = "h1:nft9As2HGrP+pT/0cC89ZpFQqa0nvKDdX/VbgWSkFwI=",
    version = "v0.0.0-20230612114953-bed058c48188",
)

go_repository(
    name = "com_github_harness_harness_core_commons_go_lib",
    importpath = "github.com/harness/harness-core/commons/go/lib",
    sum = "h1:vhGlmon9ZDL74O18dCCRVbVVGGiNTdox4Frvq+7JgQA=",
    version = "v0.0.0-20230612114953-bed058c48188",
)
