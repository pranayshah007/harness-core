...
public final class KustomizeConstants {
  ...
  static final String KUSTOMIZE_PLUGIN_FLAG_VERSION_LT_4_0_1 = "--enable_alpha_plugin";
  static final String KUSTOMIZE_PLUGIN_FLAG_LATEST = "--enable-alpha-plugin";
  static final String KUSTOMIZE_VERSION_V4_0_0 = "kustomize/v4.0.0";
}
