...
public abstract class AbstractExecutable implements Executable {
  @Override
  public AwsSamCliResponse execute(String directory, OutputStream output, OutputStream error, boolean printCommand,
    ...
    ProcessResult processResult =
        AwsSamUtils.executeScript(directory, command, output, error, timeoutInMillis, envVariables);
    return AwsSamCliResponse.builder()
