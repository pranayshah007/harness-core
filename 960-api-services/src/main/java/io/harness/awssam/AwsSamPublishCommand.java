...
public class AwsSamPublishCommand extends AbstractExecutable {
  ...
  public AwsSamPublishCommand(AwsSamClient client) {
    this.client = client;
  }

  public AwsSamPublishCommand templatePath(String templatePath) {
    this.templatePath = templatePath;
    return this;
  }

  public AwsSamPublishCommand region(String region) {
    this.region = region;
    return this;
  }

  public AwsSamPublishCommand configPath(String configPath) {
    this.configPath = configPath;
    return this;
  }

  public AwsSamPublishCommand options(String options) {
  ...
  public String command() {
    ...
    command.append(client.command()).append("publish ");
