...
public class ScmChangedFilesEvaluatorOnManager extends ScmChangedFilesEvaluator {
  ...
  public Set<String> getChangedFileset(
      ScmChangedFilesEvaluationTaskParams params, ScmConnector connector, String connectorIdentifier) {
