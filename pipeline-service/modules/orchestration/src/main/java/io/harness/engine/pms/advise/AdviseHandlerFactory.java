...
import io.harness.engine.pms.advise.handlers.MarkFailureAdviseHandler;
...
public class AdviseHandlerFactory {
  ...
  @Inject private MarkFailureAdviseHandler markFailureAdviseHandler;
  ...
  public AdviserResponseHandler obtainHandler(AdviseType adviseType) {
    switch (adviseType) {
      ...
      case MARK_FAILED:
        return markFailureAdviseHandler;
      default:
