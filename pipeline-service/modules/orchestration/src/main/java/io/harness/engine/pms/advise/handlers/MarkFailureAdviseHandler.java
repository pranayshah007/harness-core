...
public class MarkFailureAdviseHandler implements AdviserResponseHandler {
        ...
        InterruptPackage.builder()
            ...
            .interruptConfig(
                InterruptConfig.newBuilder()
                    .setIssuedBy(
                        IssuedBy.newBuilder()
                            .setAdviserIssuer(AdviserIssuer.newBuilder().setAdviserType(AdviseType.MARK_FAILED).build())
