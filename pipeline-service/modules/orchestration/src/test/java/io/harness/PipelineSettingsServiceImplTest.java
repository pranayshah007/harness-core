...
public class PipelineSettingsServiceImplTest extends OrchestrationTestBase {
  ...
  public void testGetEditionFree() throws ExecutionException {
    ...
    Edition edition = pipelineSettingsService.getEdition("accountId");
  ...
  @Owner(developers = AYUSHI_TIWARI)
  @Category(UnitTests.class)
  public void testGetEditionTeam() throws ExecutionException {
  ...
  public void testGetEditionEnterprise() throws ExecutionException {
    MockedStatic<NGRestUtils> mockRestStatic = Mockito.mockStatic(NGRestUtils.class);
    List<ModuleLicenseDTO> moduleLicenseDTOS = new ArrayList<>();
  ...
  public void testShouldQueuePlanExecutionNotFree() {
    ...
    PlanExecutionSettingResponse planExecutionSettingResponse =
        pipelineSettingsService.shouldQueuePlanExecution("accountIdentifier", "pipelineId");
  ...
  public void testShouldQueuePlanExecutionFree() {
    ...
    doReturn(0L)
        ...
        .countRunningExecutionsForGivenPipelineInAccount("accountID", "pipelineIdentifier");

    PlanExecutionSettingResponse planExecutionSettingResponse =
        pipelineSettingsService.shouldQueuePlanExecution("accountID", "pipelineIdentifier");
    assertThat(planExecutionSettingResponse.isShouldQueue()).isFalse();
  ...
  public void testGetMaxPipelineCreationCountForFree() {
    ...
    long count = pipelineSettingsService.getMaxPipelineCreationCount("accountIdentifier");
  ...
  public void testGetMaxConcurrencyBasedOnEditionFree() {
    ...
    int count = pipelineSettingsService.getMaxConcurrencyBasedOnEdition("accountIdentifier", 1L);
    assertThat(count).isEqualTo(1L);
  }
  ...
  public void testGetMaxConcurrencyBasedOnEditionFreeException() {
    ...
    doReturn(planExecutionRestrictionConfig)
        .when(orchestrationRestrictionConfiguration)
        .getTotalParallelismStopRestriction();
    assertThatThrownBy(() -> pipelineSettingsService.getMaxConcurrencyBasedOnEdition("accountIdentifier", 4L))
  ...
  public void testGetMaxConcurrencyBasedOnEditionTeam() {
    ...
    doReturn(planExecutionRestrictionConfig)
        ...
        .getTotalParallelismStopRestriction();
    doReturn(planExecutionRestrictionConfig).when(orchestrationRestrictionConfiguration).getMaxConcurrencyRestriction();
    int count = pipelineSettingsService.getMaxConcurrencyBasedOnEdition("accountIdentifier", 2L);
    assertThat(count).isEqualTo(2L);
  }
  ...
  public void testGetMaxConcurrencyBasedOnEditionEnterprise() {
    ...
    doReturn(planExecutionRestrictionConfig)
        ...
        .getTotalParallelismStopRestriction();
    doReturn(planExecutionRestrictionConfig).when(orchestrationRestrictionConfiguration).getMaxConcurrencyRestriction();
    int count = pipelineSettingsService.getMaxConcurrencyBasedOnEdition("accountIdentifier", 3L);
    assertThat(count).isEqualTo(3L);
  }
