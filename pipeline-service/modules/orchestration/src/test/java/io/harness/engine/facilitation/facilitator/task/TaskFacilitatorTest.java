...
public class TaskFacilitatorTest extends OrchestrationTestBase {
  @Inject private TaskFacilitator taskFacilitator;
  ...
  public void shouldTestFacilitate() {
    ...
    FacilitatorResponseProto response = taskFacilitator.facilitate(ambiance, parameters);
    assertThat(response).isNotNull();
    assertThat(response.getExecutionMode()).isEqualTo(ExecutionMode.TASK);
