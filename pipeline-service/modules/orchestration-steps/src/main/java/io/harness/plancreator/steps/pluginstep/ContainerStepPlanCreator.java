...
public class ContainerStepPlanCreator extends ChildrenPlanCreator<ContainerStepNode> {
  ...
  public LinkedHashMap<String, PlanCreationResponse> createPlanForChildrenNodes(
    ...
    ByteString advisorParametersRunStep = ByteString.copyFrom(kryoSerializer.asBytes(
  ...
  private String getNextNodeId(YamlNode currentNode) {
    if (currentNode != null) {
      YamlField siblingField = currentNode.nextSiblingNodeFromParentObject("step");
      if (siblingField != null && siblingField.getNode().getUuid() != null) {
        return siblingField.getNode().getUuid();
      }
    }
    return null;
  }
