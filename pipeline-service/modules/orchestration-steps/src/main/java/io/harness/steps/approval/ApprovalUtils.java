...
public class ApprovalUtils {
  ...
  public String fetchKeysForApprovalInstance(JiraApprovalInstance jiraApprovalInstance, JiraIssueNG jiraIssueNG) {
    ...
    log.info("Key list value calculated for approval instance {} : {}", jiraApprovalInstance.getId(),
        keyListInKeyValueCriteria);
  ...
  private String fetchKeysForApprovalInstanceInternal(
    ...
    try {
      if (isNull(jiraApprovalInstance) || isNull(jiraIssueNG) || isNull(jiraIssueNG.getFieldNameToKeys())) {
        log.warn(
