...
public interface PlanExecutionResource {
  ...
  @ApiOperation(value = "Fetch the expressions at various scopes for given planExecutionId and given expressionFQN",
      nickname = "fetchExpression")
  @NGAccessControlCheck(resourceType = "PIPELINE", permission = PipelineRbacPermissions.PIPELINE_VIEW)
  @Operation(operationId = "fetchExpression",
      summary = "Fetch the expressions at various scopes for given planExecutionId and given expressionFQN",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.
        ApiResponse(responseCode = "default", description = "Tests expression for given planExecutionId")
