...
public interface PipelineResource {
  ...
  @GET
  @Path("/generateWithAI/describe/{stageName}/{stepName}")
  @ApiOperation(value = "Gets a description of step generated by AI", nickname = "describe step")
  @Operation(operationId = "describeStepWithAi", description = "Returns a Step description generated with AI",
      summary = "Generate Pipeline with AI",
      responses =
      {
        @io.swagger.v3.oas.annotations.responses.
  ...
  @PublicApi
  ResponseDTO<String>
  describeStep(@PathParam("stageName") String stageName, @PathParam("stepName") String stepName);
}
