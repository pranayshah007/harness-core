...
public class PipelineServiceApplication extends Application<PipelineServiceConfiguration> {
  ...
  public void run(PipelineServiceConfiguration appConfig, Environment environment) {
    ...
    modules.add(new ServiceResourceClientModule(appConfig.getNgManagerServiceHttpClientConfig(), appConfig.getNgManagerServiceSecret(), PIPELINE_SERVICE.getServiceId()));
    modules.add(new EnvironmentResourceClientModule(appConfig.getNgManagerServiceHttpClientConfig(), appConfig.getNgManagerServiceSecret(), PIPELINE_SERVICE.getServiceId()));
    modules.add(new InfrastructureResourceClientModule(appConfig.getNgManagerServiceHttpClientConfig(), appConfig.getNgManagerServiceSecret(), PIPELINE_SERVICE.getServiceId()));
