...
public class PipelinesApiImpl implements PipelinesApi {
  ...
  public Response updatePipeline(PipelineUpdateRequestBody requestBody, @OrgIdentifier String org,
    ...
    PipelineEntity pipelineEntity = PMSPipelineDtoMapper.toPipelineEntity(
        PipelinesApiUtils.mapUpdateToRequestInfoDTO(requestBody), account, org, project, null, pipelineVersion, true);
    PipelineCRUDResult pipelineCRUDResult = pmsPipelineService.validateAndUpdatePipeline(
        pipelineEntity, ChangeType.MODIFY, false, pipelineVersion, requestBody.getFieldsToUpdate());
