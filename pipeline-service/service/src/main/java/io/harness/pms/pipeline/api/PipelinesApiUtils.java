...
import io.harness.spec.server.pipeline.v1.w1.model.ExecutorInfo;
import io.harness.spec.server.pipeline.v1.w1.model.ExecutorInfo.TriggerTypeEnum;
import io.harness.spec.server.pipeline.v1.w1.model.GitCreateDetails;
import io.harness.spec.server.pipeline.v1.w1.model.GitDetails;
import io.harness.spec.server.pipeline.v1.w1.model.GitUpdateDetails;
import io.harness.spec.server.pipeline.v1.w1.model.NodeInfo;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineCreateRequestBody;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineGetResponseBody;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineListResponseBody;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineListResponseBody.StoreTypeEnum;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineUpdateRequestBody;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineValidationResponseBody;
import io.harness.spec.server.pipeline.v1.w1.model.PipelineValidationUUIDResponseBody;
import io.harness.spec.server.pipeline.v1.w1.model.RecentExecutionInfo;
import io.harness.spec.server.pipeline.v1.w1.model.RecentExecutionInfo.ExecutionStatusEnum;
import io.harness.spec.server.pipeline.v1.w1.model.YAMLSchemaErrorWrapper;
