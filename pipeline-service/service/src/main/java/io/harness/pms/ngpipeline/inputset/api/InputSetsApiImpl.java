...
public class InputSetsApiImpl implements InputSetsApi {
  ...
  public Response mergedInputSets(@NotNull String pipeline, String org, String project,
    ...
    GitAwareContextHelper.populateGitDetails(GitEntityInfo.builder()
                                                 ...
                                                 .parentEntityRepoName(parentEntityRepoName)
                                                 .build());
    inputSetsApiUtils.checkIfGetOnlyFileContentIsEnabled(harnessAccount, body.isGetOnlyFileContent());
    ...
    try {
      ...
      mergeInputSetResponseBody.setInputsetErrorWrapper(inputSetErrorWrapperDTO);
    ...
    mergeInputSetResponseBody.setPipelineYaml(mergedYaml);
    mergeInputSetResponseBody.setCompletePipelineYaml(fullYaml);
