...
public class ExecutionHelper {
  ...
  public final List<FeatureName> featureNames = List.of(PIE_EXPRESSION_CONCATENATION,
      ...
      PIE_SECRETS_OBSERVER, CDS_METHOD_INVOCATION_NEW_FLOW_EXPRESSION_ENGINE, CDS_USE_AMBIANCE_IN_EXPRESSION_ENGINE, CDS_NG_STRATEGY_IDENTIFIER_POSTFIX_TRUNCATION_REFACTOR);
