...
import static io.harness.beans.FeatureName.PIE_EVALUATE_EXPRESSION_TO_NULL;
...
public class ExecutionHelper {
  ...
  public final List<FeatureName> featureNames = List.of(
      PIE_EXPRESSION_CONCATENATION, PIE_EXPRESSION_DISABLE_COMPLEX_JSON_SUPPORT, PIE_EVALUATE_EXPRESSION_TO_NULL);
