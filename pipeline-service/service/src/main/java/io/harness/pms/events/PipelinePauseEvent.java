...
@Getter
@NoArgsConstructor
public class PipelinePauseEvent implements Event {
  ...
  public PipelinePauseEvent(String orgIdentifier, String accountIdentifier, String projectIdentifier,
  ...
  public String getEventType() {
    return PipelineOutboxEvents.PIPELINE_PAUSE;
  }
}
