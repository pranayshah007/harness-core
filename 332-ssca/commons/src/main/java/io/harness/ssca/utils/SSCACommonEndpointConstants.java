...
public class SSCACommonEndpointConstants {
  ...
  public static final String SSCA_MANAGER_STEP_SUMMARY_ENDPOINT =
      "/v1/org/{org}/project/{project}/stepExecution/{stepExecutionId}/info";
  public static final String SSCA_MANAGER_ENFORCEMENT_ENDPOINT =
      "/v1/org/{org}/project/{project}/enforcement/{enforcementId}/summary";
