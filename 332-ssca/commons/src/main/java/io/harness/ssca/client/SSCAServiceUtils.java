...
public class SSCAServiceUtils {
  ...
  public StepExecutionResponse getStepExecutionResponse(
      String stepExecutionId, String accountId, String orgId, String projectId) {
    Call<StepExecutionResponse> call =
        sscaServiceClient.getStepExecutionInfo(orgId, projectId, stepExecutionId, accountId);
    StepExecutionResponse stepExecutionResponse = null;
    try {
