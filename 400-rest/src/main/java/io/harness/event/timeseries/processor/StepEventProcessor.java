...
public interface StepEventProcessor<T extends EventInfo> {
  ...
  String MANUAL_INTERVENTION_ID = "MANUAL_INTERVENTION_ID";
  String MANUAL_INTERVENTION_CREATED_AT = "MANUAL_INTERVENTION_CREATED_AT";
  String MANUAL_INTERVENTION_CREATED_BY = "MANUAL_INTERVENTION_CREATED_BY";
  String MANUAL_INTERVENTION_UPDATED_AT = "MANUAL_INTERVENTION_UPDATED_AT";
  String MANUAL_INTERVENTION_UPDATED_BY = "MANUAL_INTERVENTION_UPDATED_BY";
  String MANUAL_INTERVENTION_TYPE = "MANUAL_INTERVENTION_TYPE";
  String MANUAL_INTERVENTION_PARENT = "MANUAL_INTERVENTION_PARENT";
