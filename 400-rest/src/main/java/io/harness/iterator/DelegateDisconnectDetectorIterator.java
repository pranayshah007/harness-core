...
public class DelegateDisconnectDetectorIterator implements MongoPersistenceIterator.Handler<Delegate> {
  ...
  private static final long DELEGATE_EXPIRY_CHECK_MINUTES = 8L;
