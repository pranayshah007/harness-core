      ...
      ImmutableMap<String, String> scriptParams = getJarAndScriptRunTimeParamMap(
          this.finalizeTemplateParametersWithMtlsIfRequired(
              TemplateParameters.builder()
                  ...
                  .enableCCMVisibility(!CollectionUtils.isEmpty(delegateSetupDetails.getCcmFeaturesEnabled())
                      && delegateSetupDetails.getCcmFeaturesEnabled().contains(CEFeatures.VISIBILITY))
                  .enableCCMAutostopping(!CollectionUtils.isEmpty(delegateSetupDetails.getCcmFeaturesEnabled())
                      && delegateSetupDetails.getCcmFeaturesEnabled().contains(CEFeatures.OPTIMIZATION))
                  .ciEnabled(isCiEnabled)
