...
<#if useCdn == "true">
  <#noparse>
    JVM_URL=$DELEGATE_STORAGE_URL/public/shared/jre/openjdk-$3/OpenJDK11U-jre_${ARCH}_${OS}_hotspot_$3.tar.gz
  </#noparse>
<#else>
  <#noparse>
    JVM_URL=$DELEGATE_STORAGE_URL/jre/openjdk-$3/OpenJDK11U-jre_${ARCH}_${OS}_hotspot_$3.tar.gz
  </#noparse>
</#if>
