...
public class TaskTypeTest extends CategoryTest {
  ...
  public void setUp() {
    ...
    taskTypeOrdinalMapping.put(452, "HELM_FETCH_CHART_MANIFEST_TASK");
    ...
    taskTypeOrdinalMapping.put(459, "AWS_ASG_PREPARE_ROLLBACK_DATA_TASK_NG_V2");
    taskTypeOrdinalMapping.put(460, "AWS_ASG_ROLLING_DEPLOY_TASK_NG_V2");
    taskTypeOrdinalMapping.put(461, "AWS_ASG_ROLLING_ROLLBACK_TASK_NG_V2");
    taskTypeOrdinalMapping.put(462, "AWS_ASG_CANARY_DEPLOY_TASK_NG_V2");
    taskTypeOrdinalMapping.put(463, "AWS_ASG_BLUE_GREEN_PREPARE_ROLLBACK_DATA_TASK_NG_V2");
    taskTypeOrdinalMapping.put(464, "AWS_ASG_BLUE_GREEN_DEPLOY_TASK_NG_V2");
    taskTypeOrdinalMapping.put(465, "AWS_ASG_BLUE_GREEN_SWAP_SERVICE_TASK_NG_V2");
    taskTypeOrdinalMapping.put(466, "AWS_ASG_BLUE_GREEN_ROLLBACK_TASK_NG_V2");
