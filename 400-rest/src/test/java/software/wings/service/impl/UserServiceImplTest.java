...
public class UserServiceImplTest extends WingsBaseTest {
    ...
    @Mock
    HarnessCacheManager harnessCacheManager;
    @Mock
    ...
    @Mock
    NgInviteClient ngInviteClient;
    @Mock
    SignupService signupService;
    @Mock
    EventPublishHelper eventPublishHelper;
    @Mock
    TOTPAuthHandler totpAuthHandler;
    @Mock
    UserServiceLimitChecker userServiceLimitChecker;
    @Inject
    ...
    public void test_delete_when_user_part_of_only_one_NG_account() throws IOException {
        ...
        doNothing().when(auditServiceHelper).reportDeleteForAuditingUsingAccountId("ACCOUNT_ID", user1);
        doNothing().when(userServiceHelper).deleteUserFromNG("ACCOUNT_ID", user1.getUuid(), NGRemoveUserFilter.ACCOUNT_LAST_ADMIN_CHECK);
        ...
        assertThat(wingsPersistence.createQuery(UserInvite.class)
                ...
                .get())
                .isEqualTo(null);
        verify(accountService, times(0)).isNextGenEnabled("ACCOUNT_ID");
