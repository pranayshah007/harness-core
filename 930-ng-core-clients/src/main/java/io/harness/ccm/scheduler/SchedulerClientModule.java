...
public class SchedulerClientModule extends AbstractModule {
    ...
    @Inject
    public SchedulerClientModule(ServiceHttpClientConfig dkronClientConfig, String serviceSecret,
    ...
    private SchedulerHttpClientFactory providesHttpClientFactory(KryoConverterFactory kryoConverterFactory) {
        System.out.println(this.dkronClientConfig.getBaseUrl());
        return new SchedulerHttpClientFactory(this.dkronClientConfig, this.serviceSecret,
