...
import io.harness.beans.yaml.extended.infrastrucutre.DockerHostedInfraYaml;
...
public class DockerInitializeTaskUtils {
  ...
  public CIDockerInitializeTaskParams getInitializeTaskParams(
    ...
    if (infrastructure == null || ((DockerHostedInfraYaml) infrastructure).getType() == null) {
      throw new CIStageExecutionException("Input infrastructure can not be empty");
    }

    DockerHostedInfraYaml dockerInfraYaml = (DockerHostedInfraYaml) infrastructure;
  ...
  private List<DockerServiceDependency> getServiceDependencies(
      Ambiance ambiance, List<DependencyElement> dependencyElements) {
    List<DockerServiceDependency> serviceDependencies = new ArrayList<>();
  ...
  private DockerServiceDependency getServiceDependency(Ambiance ambiance, CIServiceInfo ciServiceInfo) {
    ...
    return DockerServiceDependency.builder()
