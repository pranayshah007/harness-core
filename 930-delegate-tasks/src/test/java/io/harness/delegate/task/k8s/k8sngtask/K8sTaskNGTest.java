...
package io.harness.delegate.task.k8s.k8sngtask;

import static io.harness.annotations.dev.HarnessTeam.CDP;
import static io.harness.delegate.task.k8s.k8sngtask.K8sTaskNG.KUBECONFIG_FILENAME;
...
public class K8sTaskNGTest extends CategoryTest {
  ...
  @Mock
  ContainerDeploymentDelegateBaseHelper containerDeploymentDelegateBaseHelper;
  ...
  @Mock
  K8sDeployRequest k8sDeployRequest;
  @Mock
