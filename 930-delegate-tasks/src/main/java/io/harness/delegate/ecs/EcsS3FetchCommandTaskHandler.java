...
public class EcsS3FetchCommandTaskHandler {
    ...
    try {
      ...
      if (parameters instanceof EcsS3FetchRequest) {
        ...
        commandUnitsProgress = ecsS3FetchRunTaskRequest.getCommandUnitsProgress() != null
            ...
            : CommandUnitsProgress.builder().build();
        responseData =
            getRunTaskS3FetchResponse(ecsS3FetchRunTaskRequest, commandUnitsProgress, iLogStreamingTaskClient);
      }
      return responseData;
    } catch (Exception e) {
  ...
  private DelegateResponseData getEcsS3FetchResponse(EcsS3FetchRequest ecsS3FetchRequest,
      CommandUnitsProgress commandUnitsProgress, ILogStreamingTaskClient iLogStreamingTaskClient) throws Exception {
