...
public class TasBGSetupTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject TasBlueGreenSetupTaskHandler tasBlueGreenSetupTaskHandler;

  public TasBGSetupTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        tasBlueGreenSetupTaskHandler, cfCommandRequestNG, getLogStreamingTaskClient());
  }
