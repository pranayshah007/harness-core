...
public class TasRollbackTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject CfRollbackCommandTaskHandlerNG cfRollbackCommandTaskHandlerNG;

  public TasRollbackTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        cfRollbackCommandTaskHandlerNG, cfCommandRequestNG, getLogStreamingTaskClient());
  }
