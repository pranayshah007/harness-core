...
public class GoogleFunctionDelegateTaskHelper {
    ...
    @Inject private GoogleFunctionInfraConfigHelper googleFunctionInfraConfigHelper;
        ...
        public GoogleFunctionCommandResponse getCommandResponse(
            ...
            log.info("Starting task execution for command: {}", googleFunctionCommandRequest.getGoogleFunctionCommandType().name());
            ...
            try {
                ...
                googleFunctionCommandResponse.setCommandUnitsProgress(UnitProgressDataMapper.toUnitProgressData(commandUnitsProgress));
