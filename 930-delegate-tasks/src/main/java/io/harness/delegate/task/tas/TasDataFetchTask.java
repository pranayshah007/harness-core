...
public class TasDataFetchTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject CfDataFetchCommandTaskHandlerNG cfDataFetchCommandTaskHandlerNG;

  public TasDataFetchTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        cfDataFetchCommandTaskHandlerNG, cfCommandRequestNG, getLogStreamingTaskClient());
  }
