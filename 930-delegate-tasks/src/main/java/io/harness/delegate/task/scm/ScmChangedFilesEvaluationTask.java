...
@Slf4j
public class ScmChangedFilesEvaluationTask extends AbstractDelegateRunnableTask {
  ...
  public ScmChangedFilesEvaluationTask(DelegateTaskPackage delegateTaskPackage,
  ...
  public DelegateResponseData run(TaskParameters parameters) {
    ScmChangedFilesEvaluationTaskParams filterQueryParams = (ScmChangedFilesEvaluationTaskParams) parameters;

    try {
      decrypt(filterQueryParams);
      Set<String> changedFiles = getChangedFileset(filterQueryParams, filterQueryParams.getScmConnector());
      return ScmChangedFilesEvaluationTaskResponse.builder().changedFiles(changedFiles).build();
    } catch (Exception e) {
      return ScmChangedFilesEvaluationTaskResponse.builder()
  ...
  private void decrypt(ScmChangedFilesEvaluationTaskParams filterQueryParams) {
  ...
  private Set<String> getChangedFileset(ScmChangedFilesEvaluationTaskParams params, ScmConnector connector) {
