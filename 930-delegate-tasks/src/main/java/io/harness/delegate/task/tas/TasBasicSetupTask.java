...
public class TasBasicSetupTask extends AbstractDelegateRunnableTask {
  @Inject private CfDelegateTaskHelper cfDelegateTaskHelper;
  @Inject TasBasicSetupTaskHandler tasBasicSetupTaskHandler;

  public TasBasicSetupTask(DelegateTaskPackage delegateTaskPackage, ILogStreamingTaskClient logStreamingTaskClient,
  ...
  public CfCommandResponseNG run(TaskParameters parameters) {
    ...
    return cfDelegateTaskHelper.getCfCommandResponse(
        tasBasicSetupTaskHandler, cfCommandRequestNG, getLogStreamingTaskClient());
  }
