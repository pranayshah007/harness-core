...
public class ProjectDTO {
  ...
  @JsonView(JsonViews.Internal.class) @Schema(hidden = true, description = "ParentId of Project") String parentId;
  ...
  public ProjectDTO(String orgIdentifier, String identifier, String name, String color, String description,
      Map<String, String> tags, String uniqueId, String parentId) {
