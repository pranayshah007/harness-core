...
public class EncryptionUtils {
  public static List<EncryptableSettingWithEncryptionDetails> getEncryptableSettingWithEncryptionDetailsList(
  ...
  private static EncryptableSettingWithEncryptionDetails getEncryptedDataDetail(
  ...
  private static ServiceVariable getServiceVariable(String accountId) {
