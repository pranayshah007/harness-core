...
public class GitCloneStepInfo implements CIStepInfo, WithConnectorRef {
  ...
  @ConstructorProperties({"identifier", "name", "retry", "connectorRef", "resources", "runAsUser", "repoName",
          "build", "projectName", "depth", "sslVerify", "prCloneStrategy", "cloneDirectory"})
  public GitCloneStepInfo(String identifier, String name, int retry, ParameterField<String> connectorRef,
                          ...
                          ParameterField<Boolean> sslVerify, ParameterField<PRCloneStrategy> prCloneStrategy,
                          ParameterField<String> cloneDirectory ) {
    ...
    this.prCloneStrategy = prCloneStrategy;
