...
chmod +x batch-processing/build/build_jar.sh
chmod +x batch-processing/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD batch-processing/build.properties
batch-processing/build/build_jar.sh
batch-processing/build/build_dist.sh || true
