...
public class MspMarkupAmountTasklet implements Tasklet {
  ...
  public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
    ...
    List<ManagedAccountDetails> managedAccountsList = marginDetailsService.listManagedAccountDetails(mspAccountId);
    for (ManagedAccountDetails managedAccountDetails : managedAccountsList) {
      String managedAccountId = managedAccountDetails.getAccountId();
