...
public enum BatchJobType {
  ...
  SYNC_BILLING_REPORT_S3_TO_CLICKHOUSE(105, 30, ChronoUnit.MINUTES, emptyList(), OUT_OF_CLUSTER),
  ...
  CLUSTER_DATA_HOURLY_TO_BIG_QUERY(651, 1, ChronoUnit.HOURS, Arrays.asList(), IN_CLUSTER_BILLING),
  ...
  CLUSTER_DATA_TO_BIG_QUERY(1000, 1, ChronoUnit.DAYS, Arrays.asList(), IN_CLUSTER_BILLING),
  ANOMALY_DETECTION_K8S(1000, 1, ChronoUnit.DAYS, singletonList(INSTANCE_BILLING), IN_CLUSTER_BILLING),
  ANOMALY_DETECTION_CLOUD(1000, 1, ChronoUnit.DAYS, emptyList(), IN_CLUSTER_BILLING),
