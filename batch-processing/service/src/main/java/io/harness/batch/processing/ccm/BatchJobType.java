...
public enum BatchJobType {
  ...
  COST_CATEGORY_BIGQUERY(1100, 1, ChronoUnit.MONTHS, emptyList(), IN_CLUSTER_BILLING),
  DATA_CHECK_BIGQUERY_TIMESCALE(1200, 1, ChronoUnit.DAYS, singletonList(CLUSTER_DATA_TO_BIG_QUERY), IN_CLUSTER_BILLING),
