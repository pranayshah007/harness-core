...
public enum BatchJobType {
  ...
  K8S_NODE_RECOMMENDATION(877, 1, ChronoUnit.DAYS, Collections.singletonList(K8S_UTILIZATION), IN_CLUSTER_BILLING),
  ...
  ANOMALY_DETECTION_CLOUD(1000, 1, ChronoUnit.DAYS, emptyList(), IN_CLUSTER_NODE_RECOMMENDATION),
