...
import io.harness.plancreator.steps.resourceconstraint.LockStepInfo;
...
@ApiModel(subTypes = {BarrierStepInfo.class, HttpStepInfo.class, FlagConfigurationStepInfo.class,
              ...
              PolicyStepInfo.class, ServiceNowCreateStepInfo.class, ServiceNowUpdateStepInfo.class, LockStepInfo.class})
