...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/c5f94566 \
  && curl -s -L -o client-tools/scm/c5f94566/scm https://app.harness.io/public/shared/tools/scm/release/c5f94566/bin/linux/amd64/scm
else
