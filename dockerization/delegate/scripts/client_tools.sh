...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/973aebca \
  && curl -s -L -o client-tools/scm/973aebca/scm https://app.harness.io/public/shared/tools/scm/release/973aebca/bin/linux/$ARCH/scm
else
