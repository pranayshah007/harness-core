...
if [[ ( -z "$DISABLE_CLIENT_TOOLS") || ("$DISABLE_CLIENT_TOOLS" = "false") ]]; then
  ...
  && mkdir -m 777 -p client-tools/scm/139d8c67 \
  && curl -s -L -o client-tools/scm/139d8c67/scm https://app.harness.io/public/shared/tools/scm/release/4680eeef/bin/linux/$ARCH/scm
else
