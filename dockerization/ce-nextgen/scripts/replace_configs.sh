...
replace_key_value awsConfig.destinationBucketsCount "$AWS_DESTINATION_BUCKET_COUNT"
...
replace_key_value aiEngineConfig.modelExecutionTermination "$GENAI_MODEL_EXCEUTION_TERMINATION"
replace_key_value aiEngineConfig.completeModelGenAIService.provider "$GENAI_SERVICE_PROVIDER"
replace_key_value aiEngineConfig.completeModelGenAIService.model "$GENAI_SERVICE_MODEL"
replace_key_value aiEngineConfig.completeModelGenAIService.temperature "$GENAI_SERVICE_TEMPERATURE"
replace_key_value aiEngineConfig.completeModelGenAIService.maxDecodeSteps "$GENAI_SERVICE_MAX_DECODE_STEPS"
replace_key_value aiEngineConfig.completeModelGenAIService.topP "$GENAI_SERVICE_TOP_P"
replace_key_value aiEngineConfig.completeModelGenAIService.topK "$GENAI_SERVICE_TOP_K"
replace_key_value aiEngineConfig.completeModelGenAIService.apiEndpoint "$GENAI_SERVICE_ENDPOINT"
replace_key_value aiEngineConfig.completeModelGenAIService.genAIServiceSecret "$GENAI_SERVICE_SECRET"
replace_key_value aiEngineConfig.chatModelGenAIService.provider "$GENAI_CHAT_MODEL_SERVICE_PROVIDER"
replace_key_value aiEngineConfig.chatModelGenAIService.model "$GENAI_CHAT_MODEL_SERVICE_MODEL"
replace_key_value aiEngineConfig.chatModelGenAIService.temperature "$GENAI_CHAT_MODEL_SERVICE_TEMPERATURE"
replace_key_value aiEngineConfig.chatModelGenAIService.maxDecodeSteps "$GENAI_CHAT_MODEL_SERVICE_MAX_DECODE_STEPS"
replace_key_value aiEngineConfig.chatModelGenAIService.topP "$GENAI_CHAT_MODEL_SERVICE_TOP_P"
replace_key_value aiEngineConfig.chatModelGenAIService.topK "$GENAI_CHAT_MODEL_SERVICE_TOP_K"
replace_key_value aiEngineConfig.chatModelGenAIService.apiEndpoint "$GENAI_CHAT_MODEL_SERVICE_ENDPOINT"
replace_key_value aiEngineConfig.chatModelGenAIService.genAIServiceSecret "$GENAI_SERVICE_SECRET"
