...
@Configuration
@GuiceModule
@EnableMongoRepositories(basePackages = {"io.harness.assessment.*.repositories"},
    includeFilters = @ComponentScan.Filter(HarnessRepo.class), mongoTemplateRef = "primary")
@EnableMongoAuditing
@OwnedBy(HarnessTeam.SEI)
public class AssessmentPersistenceConfig extends AbstractMongoClientConfiguration {
  protected final Injector injector;
  protected final List<Class<? extends Converter<?, ?>>> springConverters;
  protected final MongoConfig mongoConfig;
  protected final MongoClient mongoClient;

  public AssessmentPersistenceConfig(Injector injector, List<Class<? extends Converter<?, ?>>> springConverters) {
