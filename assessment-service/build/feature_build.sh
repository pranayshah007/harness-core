...
chmod +x assessment/build/build_jar.sh
chmod +x assessment/build/build_dist.sh

scripts/bazel/UpdateVersionInfoyaml.sh $BUILD assessment/build.properties
assessment/build/build_jar.sh
assessment/build/build_dist.sh || true
