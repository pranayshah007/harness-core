...
public class DelegateAgentManagerClientFactory implements Provider<DelegateAgentManagerClient> {
    ...
    @Inject
    DelegateAgentManagerClientFactory(@NotNull final DelegateConfiguration delegateConfiguration) {
        this.baseUrl = delegateConfiguration.getManagerUrl();
        this.clientCertificateFilePath = delegateConfiguration.getClientCertificateFilePath();
        this.clientCertificateKeyFilePath = delegateConfiguration.getClientCertificateKeyFilePath();
        this.trustAllCertificates = delegateConfiguration.isTrustAllCertificates();
    }
    ...
    private OkHttpClient getHttpClient(X509TrustManager trustManager)
        ...
        return Http.getOkHttpClientWithProxyAuthSetup()
            ...
            .addInterceptor(new DelegateAuthInterceptor())
