...
bazel ${bazelrc} build //delegate/src/main/java/io/harness/taskapps/http:HttpApplication_deploy.jar ${BAZEL_ARGUMENTS}
cp ${BAZEL_DIRS}/bin/delegate/src/main/java/io/harness/taskapps/http/HttpApplication_deploy.jar ./delegate/src/main/java/io/harness/taskapps/http/dockerization/TaskApp_deploy.jar
