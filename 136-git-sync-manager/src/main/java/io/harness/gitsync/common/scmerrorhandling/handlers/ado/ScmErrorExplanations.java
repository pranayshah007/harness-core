...
public class ScmErrorExplanations {
  ...
  public static final String INVALID_CONNECTOR_CREDS =
      "The credentials provided in the Azure ConnectorDisconnectHandler<CONNECTOR> are invalid or have expired.";
  ...
  public static final String MISSING_PERMISSION_CREDS_EXPLANATION =
      "The credentials provided in the Azure ConnectorDisconnectHandler<CONNECTOR> do not have correct permissions.";
