...
public interface GitXWebhookService {
  ...
  List<GitXWebhook> getGitXWebhookForGivenScope(Scope scope, String repoName);

  List<GitXWebhook> getAllGitXWebhooksForRepo(String accountIdentifier, String repoName);
