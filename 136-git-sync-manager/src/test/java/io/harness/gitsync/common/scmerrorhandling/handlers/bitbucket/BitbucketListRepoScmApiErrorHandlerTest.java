...
public class BitbucketListRepoScmApiErrorHandlerTest extends GitSyncTestBase {
  ...
  public void testHandleError() {
    assertThatThrownBy(
        () -> bitbucketListRepoScmApiErrorHandler.handleError(401, "Not Authorised", ErrorMetadata.builder().build()))
  ...
  public void testHandleErrorWhenRateLimitCode() {
    try {
      bitbucketListRepoScmApiErrorHandler.handleError(429, errorMessage, ErrorMetadata.builder().build());
    } catch (Exception ex) {
