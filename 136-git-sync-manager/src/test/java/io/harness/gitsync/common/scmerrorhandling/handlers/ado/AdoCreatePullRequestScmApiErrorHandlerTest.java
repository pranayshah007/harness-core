...
import static io.harness.exception.SCMExceptionErrorMessages.CREATE_PULL_REQUEST_FAILURE;
import static io.harness.exception.SCMExceptionErrorMessages.REPOSITORY_NOT_FOUND_ERROR;
...
public class AdoCreatePullRequestScmApiErrorHandlerTest extends GitSyncTestBase {
  ...
  public void testHandleErrorOnResourceNotFoundResponse() {
    try {
      ...
      assertThat(exception).isNotNull();
      assertThat(exception.getMessage()).isEqualTo(REPOSITORY_NOT_FOUND_ERROR);
    }
  }
  ...
  public void testHandleErrorOnBadRequestEntityResponse() {
    try {
      ...
      WingsException exception = ExceptionUtils.cause(ScmBadRequestException.class, ex);
      assertThat(exception).isNotNull();
      assertThat(exception.getMessage()).isEqualTo(CREATE_PULL_REQUEST_FAILURE);
    }
  }
