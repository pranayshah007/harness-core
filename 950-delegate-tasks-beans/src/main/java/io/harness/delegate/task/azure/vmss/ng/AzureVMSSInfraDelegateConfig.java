...
public class AzureVMSSInfraDelegateConfig implements ExpressionReflectionUtils.NestedAnnotationResolver {
  private AzureConnectorDTO azureConnectorDTO;
  @Expression(ALLOW_SECRETS) private String subscriptionId;
  @Expression(ALLOW_SECRETS) private String resourceGroup;
  private List<EncryptedDataDetail> encryptionDataDetails;

  @NotNull
  public List<DecryptableEntity> fetchDecryptableEntities() {
