...
public class AwsSamGitFetchRequest implements ActivityAccess, TaskParameters, ExecutionCapabilityDemander,
                                              ExpressionReflectionUtils.NestedAnnotationResolver {
  String activityId;
  String accountId;
  @NonFinal @Expression(ALLOW_SECRETS) AwsSamGitFetchFileConfig awsSamGitFetchFileConfig;
