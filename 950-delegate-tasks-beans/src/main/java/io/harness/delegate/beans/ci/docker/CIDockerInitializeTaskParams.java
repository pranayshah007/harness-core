...
public class CIDockerInitializeTaskParams
  ...
  @Expression(ALLOW_SECRETS) private List<DockerServiceDependency> serviceDependencies;
  ...
  public List<ExecutionCapability> fetchRequiredExecutionCapabilities(ExpressionEvaluator maskingEvaluator) {
    return Collections.singletonList(CIDockerConnectionCapability.builder().build());
  }
}
