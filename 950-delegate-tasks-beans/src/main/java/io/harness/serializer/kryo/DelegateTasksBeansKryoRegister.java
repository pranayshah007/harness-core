...
import io.harness.delegate.task.serverless.request.*;
import io.harness.delegate.task.serverless.response.*;
...
public class DelegateTasksBeansKryoRegister implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(ServerlessGenericRequest.class, 563537);
    kryo.register(ServerlessGenericResponse.class, 5635378);
