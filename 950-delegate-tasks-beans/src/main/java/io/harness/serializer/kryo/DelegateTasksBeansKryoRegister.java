...
public class DelegateTasksBeansKryoRegister implements KryoRegistrar {
  ...
  public void register(Kryo kryo) {
    ...
    kryo.register(GoogleFunctionDeployRequest.class, 673588);
    kryo.register(GoogleFunctionDeployResponse.class, 673587);
    kryo.register(GcpGoogleFunctionInfraConfig.class, 673586);
    kryo.register(GoogleCloudStorageArtifactConfig.class, 673585);
    kryo.register(GoogleFunctionCommandTypeNG.class, 673584);
