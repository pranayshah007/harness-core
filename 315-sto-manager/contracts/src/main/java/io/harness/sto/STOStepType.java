...
public enum STOStepType {
  AQUA_TRIVY("AquaTrivy", FeatureName.STO_STEP_PALETTE_V1, AquaTrivyScanNode.class, EntityType.AQUA_TRIVY,
      new String[] {SECURITY}),
  AWS_ECR("AWSECR", FeatureName.STO_STEP_PALETTE_V3, AwsEcrScanNode.class, EntityType.AWS_ECR, new String[] {SECURITY}),
  AWS_SECURITY_HUB("AWSSecurityHub", FeatureName.STO_STEP_PALETTE_V3, AwsSecurityHubNode.class,
  ...
  BRAKEMAN("Brakeman", FeatureName.STO_STEP_PALETTE_V2, BrakemanScanNode.class, EntityType.BRAKEMAN,
      new String[] {SECURITY}),
  BURP("Burp", FeatureName.STO_STEP_PALETTE_V4, BurpScanNode.class, EntityType.BURP, new String[] {SECURITY}),
  CHECKMARX("Checkmarx", FeatureName.STO_STEP_PALETTE_V1, CheckmarxScanNode.class, EntityType.CHECKMARX,
      new String[] {SECURITY}),
  CLAIR("Clair", FeatureName.STO_STEP_PALETTE_V4, ClairScanNode.class, EntityType.CLAIR, new String[] {SECURITY}),
  DATA_THEOREM("DataTheorem", FeatureName.STO_STEP_PALETTE_V4, DataTheoremScanNode.class, EntityType.DATA_THEOREM,
      new String[] {SECURITY}),
  DOCKER_CONTENT_TRUST("DockerContentTrust", FeatureName.STO_STEP_PALETTE_V3, DockerContentTrustScanNode.class,
      EntityType.DOCKER_CONTENT_TRUST, new String[] {SECURITY}),
  EXTERNAL("External", FeatureName.STO_STEP_PALETTE_V3, ExternalScanNode.class, EntityType.EXTERNAL,
      new String[] {SECURITY}),
  FORTIFY_ON_DEMAND("FortifyOnDemand", FeatureName.STO_STEP_PALETTE_V4, FortifyOnDemandScanNode.class,
  ...
  JFROG_XRAY("JfrogXray", FeatureName.STO_STEP_PALETTE_V4, JfrogXrayScanNode.class, EntityType.JFROG_XRAY,
      new String[] {SECURITY}),
  MEND("Mend", FeatureName.STO_STEP_PALETTE_V1, MendScanNode.class, EntityType.MEND, new String[] {SECURITY}),
  METASPLOIT("Metasploit", FeatureName.STO_STEP_PALETTE_V4, MetasploitScanNode.class, EntityType.METASPLOIT,
      new String[] {SECURITY}),
  NESSUS("Nessus", FeatureName.STO_STEP_PALETTE_V4, NessusScanNode.class, EntityType.NESSUS, new String[] {SECURITY}),
  NEXUS_IQ(
      "NexusIQ", FeatureName.STO_STEP_PALETTE_V4, NexusIQScanNode.class, EntityType.NEXUS_IQ, new String[] {SECURITY}),
  ...
  OPENVAS(
      "Openvas", FeatureName.STO_STEP_PALETTE_V4, OpenvasScanNode.class, EntityType.OPENVAS, new String[] {SECURITY}),
  ...
  PRISMA_CLOUD("PrismaCloud", FeatureName.STO_STEP_PALETTE_V1, PrismaCloudScanNode.class, EntityType.PRISMA_CLOUD,
      new String[] {SECURITY}),
  PROWLER(
      "Prowler", FeatureName.STO_STEP_PALETTE_V3, ProwlerScanNode.class, EntityType.PROWLER, new String[] {SECURITY}),
  QUALYS("Qualys", FeatureName.STO_STEP_PALETTE_V4, QualysScanNode.class, EntityType.QUALYS, new String[] {SECURITY}),
  REAPSAW(
      "Reapsaw", FeatureName.STO_STEP_PALETTE_V4, ReapsawScanNode.class, EntityType.REAPSAW, new String[] {SECURITY}),
  SHIFT_LEFT("ShiftLeft", FeatureName.STO_STEP_PALETTE_V4, ShiftLeftScanNode.class, EntityType.SHIFT_LEFT,
      new String[] {SECURITY}),
  SNIPER("Sniper", FeatureName.STO_STEP_PALETTE_V4, SniperScanNode.class, EntityType.SNIPER, new String[] {SECURITY}),
  ...
  SONARQUBE("Sonarqube", FeatureName.STO_STEP_PALETTE_V1, SonarqubeScanNode.class, EntityType.SONARQUBE,
      new String[] {SECURITY}),
  SYSDIG("Sysdig", FeatureName.STO_STEP_PALETTE_V4, SysdigScanNode.class, EntityType.SYSDIG, new String[] {SECURITY}),
  TENABLE(
      "Tenable", FeatureName.STO_STEP_PALETTE_V4, TenableScanNode.class, EntityType.TENABLE, new String[] {SECURITY}),
