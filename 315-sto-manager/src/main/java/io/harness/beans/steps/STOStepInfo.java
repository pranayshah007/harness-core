...
@ApiModel(
    subTypes = {AquaTrivyStepInfo.class, AwsEcrStepInfo.class, BanditStepInfo.class, BlackDuckStepInfo.class,
        BrakemanStepInfo.class, BurpStepInfo.class, CheckmarxStepInfo.class, DataTheoremStepInfo.class,
        DockerContentTrustScanNode.class, ExternalScanNode.class, FortifyOnDemandStepInfo.class, GrypeStepInfo.class,
        MendStepInfo.class, MetasploitStepInfo.class, NmapStepInfo.class, NiktoStepInfo.class, NessusStepInfo.class,
        NexusIQStepInfo.class, OpenvasStepInfo.class, OwaspStepInfo.class, ProwlerStepInfo.class, QualysStepInfo.class,
        ReapsawStepInfo.class, ShiftLeftStepInfo.class, SniperStepInfo.class, SysdigStepInfo.class,
