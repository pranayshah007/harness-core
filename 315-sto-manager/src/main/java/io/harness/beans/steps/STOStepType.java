...
public enum STOStepType {
  ...
  BANDIT("Bandit", FeatureName.STO_STEP_PALETTE_V2, BanditScanNode.class, EntityType.BANDIT,
      new BanditStepPlanCreator(), new String[] {"Security"}),
  BLACKDUCK("BlackDuck", FeatureName.STO_STEP_PALETTE_V2, BlackDuckScanNode.class, EntityType.BLACKDUCK,
      new BlackDuckStepPlanCreator(),
      new String[] {
          ,
      }),
  ...
  BURP("Burp", FeatureName.STO_STEP_PALETTE_V2, BurpScanNode.class, EntityType.BURP, new BurpStepPlanCreator(),
      new String[] {"Security"}),
  CHECKMARX("Checkmarx", FeatureName.STO_STEP_PALETTE_V2, CheckmarxScanNode.class, EntityType.CHECKMARX,
  ...
  OWASP("Owasp", FeatureName.STO_STEP_PALETTE_V2, OwaspScanNode.class, EntityType.OWASP, new OwaspStepPlanCreator(),
      new String[] {"Security"}),
  PRISMA_CLOUD("PrismaCloud", FeatureName.STO_STEP_PALETTE_V2, PrismaCloudScanNode.class, EntityType.PRISMA_CLOUD,
  ...
  SNYK("Snyk", FeatureName.STO_STEP_PALETTE_V2, SnykScanNode.class, EntityType.SNYK, new SnykStepPlanCreator(),
      new String[] {
          ,
      }),
  SONARQUBE("Sonarqube", FeatureName.STO_STEP_PALETTE_V2, SonarqubeScanNode.class, EntityType.SONARQUBE,
  ...
  ZAP("Zap", FeatureName.STO_STEP_PALETTE_V2, ZapScanNode.class, EntityType.ZAP, new ZapStepPlanCreator(),
      new String[] {"Security"});
