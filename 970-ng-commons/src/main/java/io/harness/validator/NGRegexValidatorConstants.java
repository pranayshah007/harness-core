...
public interface NGRegexValidatorConstants {
  String BLACKLIST_WORDS =
      "^(?!or$|and$|eq$|ne$|it$|gt$|le$|ge$|div$|mod$|not$|null$|true$|false$|new$|var$|return$|step$|parallel$|stepGroup$|org$|account$)";
  String IDENTIFIER_PATTERN = BLACKLIST_WORDS + "[a-zA-Z_][0-9a-zA-Z_]{0,63}$";
  String PIPELINE_IDENTIFIER_PATTERN = BLACKLIST_WORDS + "[a-zA-Z_][0-9a-zA-Z_]{0,127}$";
