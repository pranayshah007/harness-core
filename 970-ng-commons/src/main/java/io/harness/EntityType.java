...
public enum EntityType {
  ...
  @JsonProperty(EntityTypeConstants.SSCA_ORCHESTRATION_STEP)
  SSCA_ORCHESTRATION_STEP(ModuleType.CI, EntityTypeConstants.SSCA_ORCHESTRATION_STEP, IdentifierRef.class);
