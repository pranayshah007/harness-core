...
public class NormalizeSbomServiceImplTest extends SSCAManagerTestBase {
  ...
  public void setup() throws IllegalAccessException {
    ...
    FieldUtils.writeField(normalizeSbomService, "sbomComponentRepo", sbomComponentRepo, true);
  }
  ...
  public void testListNormalizedSbomComponent() {
    ...
    Response response = normalizeSbomService.listNormalizedSbomComponent("org", "project", 2, 2, "id", "accountId");
