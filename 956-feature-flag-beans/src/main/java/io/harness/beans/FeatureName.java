...
public enum FeatureName {
  ...
  DO_NOT_ENFORCE_LIMITS_ON_CONCURRENT_PIPELINE_EXECUTIONS(
      "Enabling this FF won't enforce any limits on concurrent pipeline executions", HarnessTeam.PIPELINE);
