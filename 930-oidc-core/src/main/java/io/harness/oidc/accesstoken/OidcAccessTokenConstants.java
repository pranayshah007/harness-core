...
public class OidcAccessTokenConstants {
  ...
  public static final String ACCESS_TOKEN_EXCHANGE_ENDPOINT = "access_token_exchange_endpoint";
  public static final String ACCESS_TOKEN_CONFIG = "access_token_config";
