...
import io.harness.oidc.jwks.OidcJwksKeysForIdToken;
...
public class GcpOidcTokenUtility {
  ...
  public String generateGcpOidcIdToken(GcpOidcTokenRequestDTO gcpOidcTokenRequestDTO) {
    ...
    OidcJwksKeysForIdToken oidcJwksKeysForIdToken =
        oidcJwksUtility.getJwksKeysForIdToken(gcpOidcTokenRequestDTO.getAccountId());

    // parse the base token structure and generate appropriate values
    OidcIdTokenHeaderStructure finalOidcIdTokenHeader =
        parseOidcIdTokenHeader(baseOidcIdTokenHeaderStructure, oidcJwksKeysForIdToken.getKid());
    ...
    return generateOidcIdToken(
        finalOidcIdTokenHeader, finalOidcIdTokenPayload, oidcJwksKeysForIdToken.getRsaPrivateKey());
  }
