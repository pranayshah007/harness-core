...
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.KEY_VALUE_DELIMITER_KEY;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.KEY_VALUE_DELIMITER_PARAM_MESSAGE;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.PLAN_EXECUTION_ID_PARAM_MESSAGE;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.ROW_DELIMITER_KEY;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.ROW_DELIMITER_PARAM_MESSAGE;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.STAGE_EXECUTION_IDENTIFIERS_KEY;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.STAGE_EXECUTION_IDENTIFIERS_PARAM_MESSAGE;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.STAGE_IDENTIFIERS_KEY;
import static io.harness.cdng.stage.resources.CDNGStageSummaryResourceConstants.STAGE_IDENTIFIERS_PARAM_MESSAGE;
...
public interface CDNGStageSummaryResource {
  ...
  listStageExecutionFormattedSummary(
      ...
      @NotNull @QueryParam(ROW_DELIMITER_KEY) @Parameter(description = ROW_DELIMITER_PARAM_MESSAGE) String rowDelimiter,
      @NotNull @QueryParam(KEY_VALUE_DELIMITER_KEY) @Parameter(
          description = KEY_VALUE_DELIMITER_PARAM_MESSAGE) String keyValueDelimiter);
