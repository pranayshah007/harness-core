...
public class CDNGStageSummaryResourceImpl implements CDNGStageSummaryResource {
  ...
  @Override
  public ResponseDTO<Map<String, String>> listStageExecutionFormattedSummary(@NotNull String accountId,
      @NotNull String orgIdentifier, @NotNull String projectIdentifier,
      @NotNull @NotEmpty List<String> stageExecutionIdentifiers, @NotNull String rowDelimiter,
    ...
    return ResponseDTO.newResponse(
        stageExecutionInfoService.listStageExecutionFormattedSummaryByStageExecutionIdentifiers(
            Scope.of(accountId, orgIdentifier, projectIdentifier), stageExecutionIdentifiers, rowDelimiter,
            keyValueDelimiter));
  }

  @Override
  public ResponseDTO<Map<String, String>> listStagePlanCreationFormattedSummary(@NotNull String accountId,
      @NotNull String orgIdentifier, @NotNull String projectIdentifier, @NotNull String planExecutionId,
      @NotNull @NotEmpty List<String> stageIdentifiers, @NotNull String rowDelimiter, @NotNull String keyValueDelimiter

  ) {
    return ResponseDTO.newResponse(
        deploymentStagePlanCreationInfoService.listStagePlanCreationFormattedSummaryByStageIdentifiers(
            Scope.of(accountId, orgIdentifier, projectIdentifier), planExecutionId, stageIdentifiers, rowDelimiter,
            keyValueDelimiter));
  }
}
