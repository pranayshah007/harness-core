...
public class DeploymentStagePlanCreationInfoServiceImpl implements DeploymentStagePlanCreationInfoService {
  ...
  @Override
  public Map<String, String> listStagePlanCreationFormattedSummaryByStageIdentifiers(@Valid @NotNull Scope scope,
      @NotNull String planExecutionId, @NotNull List<String> stageIdentifiers, @NotNull String rowDelimiter,
    ...
    Map<String, String> deploymentStagePlanCreationInfoStageMap = new HashMap<>();
    ...
    return deploymentStagePlanCreationInfoList.stream().collect(
        Collectors.toMap(DeploymentStagePlanCreationInfo::getStageIdentifier,
            detailsInfo
            -> detailsInfo.getDeploymentStageDetailsInfo().getFormattedStageSummary(rowDelimiter, keyValueDelimiter)));
  }
}