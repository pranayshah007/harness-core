...
public class HelmChartManifestTaskHandlerTest extends CategoryTest {
  ...
  public void testCreateTaskData() {
    ...
    final HelmFetchChartManifestTaskParameters helmFetchTaskParameters = (HelmFetchChartManifestTaskParameters) taskParameters;
  ...
  public void testUpdateManifestOutcome() {
    ...
    final HelmChartManifestOutcome manifestOutcome = HelmChartManifestOutcome.builder()
  ...
  public void testUpdateManifestOutcomeNullManifest() {
    final HelmFetchChartManifestResponse response = HelmFetchChartManifestResponse.builder().helmChartManifest(HelmChartManifest.builder().build()).build();
