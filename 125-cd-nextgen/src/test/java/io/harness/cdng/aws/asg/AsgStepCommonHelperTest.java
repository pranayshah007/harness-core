...
public class AsgStepCommonHelperTest extends CategoryTest {
  ...
  public void isV2Feature() {
    ...
    ret = asgStepCommonHelper.isV2Feature(null, ElastigroupInstances.builder().build(), null, null, null);
    assertThat(ret).isEqualTo(true);

    ret = asgStepCommonHelper.isV2Feature(null, null, List.of(LoadBalancer.builder().build()), null, null);
    assertThat(ret).isEqualTo(true);
