...
public class AsgCanaryDeleteStepTest extends CategoryTest {
    ...
    private final Ambiance ambiance = Ambiance.newBuilder()
            ...
            .build();
    private final AsgCanaryDeleteStepParameters asgSpecParameters = AsgCanaryDeleteStepParameters.infoBuilder().asgCanaryDeleteFqn("delete").asgCanaryDeployFqn("deploy").build();
    ...
    @Spy @InjectMocks
    private AsgCanaryDeleteStep asgCanaryDeleteStep;
    ...
    public void obtainTaskAfterRbacEcsCanaryDeleteDataOptionalOutputNotFoundTest() {
        ...
        StepElementParameters stepElementParameters = StepElementParameters.builder()
                .spec(asgSpecParameters)
                .timeout(ParameterField.createValueField("10m"))
                .build();

        AsgCanaryDeployOutcome asgCanaryDeployOutcome = AsgCanaryDeployOutcome.builder()
                .canaryAsgName("asgCanary")
                .build();
    ...
    public void obtainTaskAfterRbacNoStepInRollbackSectionTest() {
        ...
        TaskChainResponse taskChainResponseAssert = TaskChainResponse.builder()
                ...
                .build();
        doReturn(taskChainResponseAssert).when(asgStepCommonHelper).queueAsgTask(any(), any(), any(), any(), anyBoolean(), any(TaskType.class));
        ...
        verify(asgStepCommonHelper)
                .queueAsgTask(stepElementParameters, asgCanaryDeleteRequest, ambiance,
                        EcsExecutionPassThroughData.builder().infrastructure(infrastructureOutcome).build(), true,AWS_ASG_CANARY_DELETE_TASK_NG );
    }
}
