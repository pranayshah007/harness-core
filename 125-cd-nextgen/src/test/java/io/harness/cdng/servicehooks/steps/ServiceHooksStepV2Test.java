...
import io.harness.cdng.hooks.steps.ServiceHooksStepV2;
...
public class ServiceHooksStepV2Test extends CategoryTest {
  ...
  @InjectMocks private final ServiceHooksStepV2 step = new ServiceHooksStepV2();
  ...
  public void executeSync() {
    ServiceHookWrapper file1 = sampleConfigFile("file1");
    ServiceHookWrapper file2 = sampleConfigFile("file2");
    ServiceHookWrapper file3 = sampleConfigFile("file3");

    doReturn(OptionalSweepingOutput.builder()
                 .found(true)
                 .output(NgServiceHooksMetadataSweepingOutput.builder()
    ...
    verify(mockSweepingOutputService, times(1)).consume(any(), eq("serviceHooks"), captor.capture(), eq("STAGE"));
  ...
  private ServiceHookWrapper sampleConfigFile(String identifier) {
