...
public class JenkinsBuildStepHelperServiceImplTest extends CategoryTest {
  ...
  public void testPrepareTestRequest() throws Exception {
    ...
    aStatic.when(() -> NGRestUtils.getResponse(any()))
        .thenReturn(Optional.of(
            ConnectorDTO.builder()
                ...
                .build()));
    // when(artifactTaskExecutionResponse.getJenkinsBuildTaskNGResponse().getExecutionStatus()).thenReturn(ExecutionStatus.FAILED);
