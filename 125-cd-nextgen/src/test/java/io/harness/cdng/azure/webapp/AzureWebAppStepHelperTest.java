...
public class AzureWebAppStepHelperTest extends CDNGTestBase {
  ...
  public void testFetchWebAppConfigWithOverrides() {
    ...
    doReturn(OptionalSweepingOutput.builder()
        ...
        .when(sweepingOutputService)
        .resolveOptional(
            eq(ambiance), eq(RefObjectUtils.getOutcomeRefObject(ServiceStepV2.SERVICE_APP_SETTINGS_SWEEPING_OUTPUT)));
    ...
    doReturn(
        ...
        .resolveOptional(eq(ambiance),
            eq(RefObjectUtils.getOutcomeRefObject(ServiceStepV2.SERVICE_CONNECTION_STRINGS_SWEEPING_OUTPUT)));
