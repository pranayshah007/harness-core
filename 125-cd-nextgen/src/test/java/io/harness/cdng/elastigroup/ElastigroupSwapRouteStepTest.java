...
public class ElastigroupSwapRouteStepTest extends CDNGTestBase {
  ...
  public void executeElastigroupTaskTest() {
    ...
    StepElementParameters stepElementParameters =
            StepElementParameters.builder().spec(elastigroupSwapRouteStepParameters).timeout(ParameterField.createValueField("10m")).build();
    ...
    ElastigroupSetupDataOutcome elastigroupSetupDataOutcome =
            ElastigroupSetupDataOutcome.builder()
                    ...
                    .build();
    OptionalSweepingOutput optionalElastigroupSetupOutput = OptionalSweepingOutput.builder().output(elastigroupSetupDataOutcome).build();
     doReturn(optionalElastigroupSetupOutput).when(executionSweepingOutputService).resolveOptional(ambiance,
  ...
  public void finalizeExecutionWithSecurityContextTest() throws Exception {
    ...
    ElastigroupSwapRouteResult elastigroupSwapRouteResult = ElastigroupSwapRouteResult.builder()
            .newElastiGroupId(newElastiGroupId)
            .build();
    UnitProgressData unitProgressData = UnitProgressData.builder().build();
    ElastigroupSwapRouteResponse elastigroupSwapRouteResponse = ElastigroupSwapRouteResponse.builder()
