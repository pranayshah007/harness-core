...
public class CdngNotifyEventConsumerRedis extends PmsAbstractRedisConsumer<CdngNotifyEventMessageListener> {
  @Inject
  public CdngNotifyEventConsumerRedis(@Named(CDNG_ORCHESTRATION_EVENT_CONSUMER) Consumer redisConsumer,
      CdngNotifyEventMessageListener sdkOrchestrationEventMessageListener,
