...
@NoArgsConstructor
@AllArgsConstructor
@TypeAlias("pcfAppSetupBaseStepInfo")
public class PcfAppSetupBaseStepInfo {
  @ApiModelProperty(dataType = BOOLEAN_CLASSPATH)
  @YamlSchemaTypes({string})
  ParameterField<Boolean> useAutoScalarPlugin;
  @NotNull PcfInstanceCountType instanceCount;
  @NotNull PcfResizeStrategyType resizeStrategy;
  @NotNull PcfVersionManagementType versionManagement;
  ...
  ParameterField<List<String>> additionalRoutes;
