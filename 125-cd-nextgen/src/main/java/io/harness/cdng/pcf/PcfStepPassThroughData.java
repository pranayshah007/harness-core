...
@TypeAlias("pcfStepPassThroughData")
@RecasterAlias("io.harness.cdng.pcf.PcfStepPassThroughData")
public class PcfStepPassThroughData implements PassThroughData {
