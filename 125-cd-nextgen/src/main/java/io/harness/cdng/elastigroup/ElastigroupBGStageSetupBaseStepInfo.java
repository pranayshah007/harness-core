...
@NoArgsConstructor
@AllArgsConstructor
@TypeAlias("elastigroupBGStageSetupBaseStepInfo")
@FieldNameConstants(innerTypeName = "ElastigroupBGStageSetupBaseStepInfoKeys")
public class ElastigroupBGStageSetupBaseStepInfo {
