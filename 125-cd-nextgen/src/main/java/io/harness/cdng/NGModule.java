...
import io.harness.cdng.plugininfoproviders.ServelessPrepareRollbackPluginInfoProvider;
...
public class NGModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    pluginInfoProviderMultibinder.addBinding().to(ServelessPrepareRollbackPluginInfoProvider.class);
  }
}
