...
import io.harness.cdng.k8s.K8sBlueGreenStepParameters;
...
public class K8sBlueGreenStepV2 implements AsyncChainExecutableWithRbac, K8sStepExecutor {
  public static final StepType STEP_TYPE = StepType.newBuilder()
                                               .setType(ExecutionNodeType.K8S_BLUE_GREEN_V2.getYamlType())
  ...
  @Override
  public void handleExpire(Ambiance ambiance, StepParameters stepParameters, Object executableResponse) {}
  ...
  @Override
  public StepResponse finalizeExecutionWithSecurityContext(
      Ambiance ambiance, StepParameters stepParameters, ThrowingSupplier responseDataSupplier) throws Exception {
    return null;
  }

  @Override
  public AsyncChainExecutableResponse executeNextLinkWithSecurityContext(Ambiance ambiance,
      StepParameters stepParameters, StepInputPackage inputPackage, ThrowingSupplier responseSupplier)
      throws Exception {
    return null;
  }
}
