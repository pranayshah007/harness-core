...
@TypeAlias("awsCdkDiffStepParameters")
@RecasterAlias("io.harness.cdng.provision.awscdk.AwsCdkDiffStepParameters")
public class AwsCdkDiffStepParameters extends AwsCdkBaseStepInfo implements SpecParameters, StepParameters {
  ParameterField<Boolean> exportTemplate;
  ParameterField<List<String>> stackNames;

  @Builder(builderMethodName = "infoBuilder")
  public AwsCdkDiffStepParameters(ParameterField<List<TaskSelectorYaml>> delegateSelectors,
