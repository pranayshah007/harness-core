...
public class TerraformRollbackStepVariableCreator extends GenericStepVariableCreator<TerraformRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.TERRAFORM_ROLLBACK);
  }
