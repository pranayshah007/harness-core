...
@OwnedBy(CDP)
public class AzureWebAppRollbackStepVariableCreator extends GenericStepVariableCreator<AzureWebAppRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AZURE_WEBAPP_ROLLBACK);
  }
