  ...
  public StepResponse handleTaskResultWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
    ...
    try {
      ...
      if (googleFunctionGenOneRollbackResponse.isFunctionDeleted()) {
        ...
        stepResponse =
                googleFunctionsHelper.generateStepResponse(googleFunctionGenOneRollbackResponse, stepResponseBuilder, ambiance);
      }
    } catch (Exception e) {
  ...
  public TaskRequest obtainTaskAfterRbac(
    ...
    GoogleFunctionGenOneRollbackRequest googleFunctionGenOneRollbackRequest =
            GoogleFunctionGenOneRollbackRequest.builder()
                    ...
                    .createFunctionRequestAsString(googleFunctionGenOnePrepareRollbackOutcome.getCreateFunctionRequestAsString())
