...
public class GoogleFunctionsDeployWithoutTrafficStep
  ...
  public StepResponse finalizeExecutionWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
    ...
    InfrastructureOutcome infrastructureOutcome = googleFunctionsStepPassThroughData.getInfrastructureOutcome();
    ServerInstanceInfo serverInstanceInfo = googleFunctionsHelper.getServerInstanceInfo(
        googleFunctionDeployWithoutTrafficResponse, infrastructureOutcome.getInfrastructureKey());
