...
import io.harness.cdng.awssam.AwsSamStepCommonHelper;
import io.harness.cdng.awssam.beans.AwsSamExecutionPassThroughData;
import io.harness.cdng.awssam.beans.AwsSamPackageDataOutcome;
...
public class AwsSamPublishStep extends CdTaskExecutable<AwsSamCommandResponse> {
  ...
  private StepResponse generateStepResponse(Ambiance ambiance, AwsSamPublishResponse awsSamPublishResponse,
      StepResponse.StepResponseBuilder stepResponseBuilder) {
  ...
  public TaskRequest obtainTaskAfterRbac(
    ...
    AwsSamPublishConfig awsSamPublishConfig =
        AwsSamPublishConfig.builder()
            ...
            .build();
    AwsSamPackageDataOutcome awsSamPackageDataOutcome =
        (AwsSamPackageDataOutcome) awsSamPublishDataOptionalOutput.getOutput();
    ...
    AwsSamPublishRequest awsSamCommandRequest =
        AwsSamPublishRequest.builder()
            ...
            .awsSamPublishConfig(awsSamPublishConfig)
            .templateFileContent(awsSamPackageDataOutcome.getTemplateFileContent())
            .configFileContent(awsSamPackageDataOutcome.getConfigFileContent())
            .build();
