...
import io.harness.cdng.aws.lambda.rollback.AwsLambdaRollbackBaseStepInfo;
...
@ApiModel(
    subTypes = {CreatePRStepInfo.class, MergePRStepInfo.class, K8sApplyStepInfo.class, K8sBlueGreenStepInfo.class,
        ...
        GoogleFunctionsTrafficShiftStepInfo.class, GoogleFunctionsRollbackStepInfo.class, AwsLambdaRollbackBaseStepInfo.class})
