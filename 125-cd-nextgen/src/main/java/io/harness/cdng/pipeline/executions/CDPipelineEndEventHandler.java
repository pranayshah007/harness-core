...
public class CDPipelineEndEventHandler implements OrchestrationEventHandler {
  ...
  public void handleEvent(OrchestrationEvent event) {
    ...
    long countOfDistinctActiveServiceInstances =
        cdPipelineInstrumentationHelper.getCountOfDistinctActiveServiceInstancesInInterval(
            accountId, orgId, projectId, currentTS - searchingPeriod, currentTS);
    cdPipelineInstrumentationHelper.sendCountOfDistinctActiveServicesEvent(
        pipelineId, identity, accountId, accountName, orgId, projectId, countOfDistinctActiveServiceInstances);
  }
}
