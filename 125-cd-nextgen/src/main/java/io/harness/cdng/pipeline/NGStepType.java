...
public enum NGStepType {
  ...
  @JsonProperty(StepSpecTypeConstants.TAS_SWAP_ROLLBACK)
  TAS_SWAP_ROLLBACK("TAS Swap Rollback", Arrays.asList(ServiceDefinitionType.TAS), "TAS",
          StepSpecTypeConstants.TAS_SWAP_ROLLBACK);
