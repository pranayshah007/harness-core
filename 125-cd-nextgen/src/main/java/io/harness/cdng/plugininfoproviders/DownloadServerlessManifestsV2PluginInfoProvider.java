...
public class DownloadServerlessManifestsV2PluginInfoProvider implements CDPluginInfoProvider {
  ...
  public PluginCreationResponseList getPluginInfoList(
    ...
    GitCloneStepInfo gitCloneStepInfo =
        downloadManifestsStepHelper.getGitCloneStepInfoFromManifestOutcome(serverlessAwsLambdaManifestOutcome);
  ...
  public boolean isSupported(String stepType) {
    if (stepType.equals(StepSpecTypeConstants.DOWNLOAD_SERVERLESS_MANIFESTS)) {
      return true;
    }
    return false;
  }
