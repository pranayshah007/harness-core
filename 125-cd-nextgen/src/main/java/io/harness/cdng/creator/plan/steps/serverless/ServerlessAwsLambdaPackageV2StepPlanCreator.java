...
public class ServerlessAwsLambdaPackageV2StepPlanCreator
  ...
  protected StepParameters getStepParameters(PlanCreationContext ctx, ServerlessAwsLambdaPackageV2StepNode stepNode) {
    ...
    String prepareRollbackFqn = getExecutionStepFqn(ctx.getCurrentField(), SERVERLESS_AWS_LAMBDA_PREPARE_ROLLBACK_V2);
    ...
    serverlessAwsLambdaPackageV2StepParameters.setPrepareRollbackFqn(prepareRollbackFqn);
