...
import io.harness.cdng.creator.plan.steps.CDPMSTemplatedStepFilterJsonCreator;
...
import io.harness.cdng.creator.plan.steps.TemplatedCommandStepPlanCreator;
...
import io.harness.cdng.creator.variables.TemplatedCommandStepVariableCreator;
...
public class CDNGPlanCreatorProvider implements PipelineServiceInfoProvider {
  ...
  public List<PartialPlanCreator<?>> getPlanCreators() {
    ...
    planCreators.add(new TemplatedCommandStepPlanCreator());
  ...
  public List<FilterJsonCreator> getFilterJsonCreators() {
    ...
    filterJsonCreators.add(new CDPMSTemplatedStepFilterJsonCreator());
  ...
  public List<VariableCreator> getVariableCreators() {
    ...
    variableCreators.add(new TemplatedCommandStepVariableCreator());
