...
public class TasRollingDeployStepVariableCreator extends GenericStepVariableCreator<TasRollingDeployStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.TAS_ROLLING_DEPLOY);
  }
