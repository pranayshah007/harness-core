...
public class TasRollingRollbackStepVariableCreator extends GenericStepVariableCreator<TasRollingRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.TAS_ROLLING_ROLLBACK);
  }
