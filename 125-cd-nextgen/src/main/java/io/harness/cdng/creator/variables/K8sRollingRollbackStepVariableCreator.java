...
public class K8sRollingRollbackStepVariableCreator extends GenericStepVariableCreator<K8sRollingRollbackStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.K8S_ROLLING_ROLLBACK);
  }
