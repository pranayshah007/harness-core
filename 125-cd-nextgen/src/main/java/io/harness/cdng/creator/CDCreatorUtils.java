...
public class CDCreatorUtils {
  ...
  public Set<String> getSupportedStepsV2() {
    return Sets.newHashSet(StepSpecTypeConstants.GITOPS_CREATE_PR, StepSpecTypeConstants.GITOPS_MERGE_PR,
        ...
        StepSpecTypeConstants.AWS_SAM_DEPLOY, StepSpecTypeConstants.AWS_SAM_BUILD,
        StepSpecTypeConstants.AWS_SAM_ROLLBACK, StepSpecTypeConstants.BAMBOO_BUILD,
        ...
        StepSpecTypeConstants.K8S_BLUE_GREEN_STAGE_SCALE_DOWN, StepSpecTypeConstants.SERVERLESS_PREPARE_ROLLBACK, StepSpecTypeConstants.SERVERLESS_ROLLBACK);
  }
}
