...
public class CDCreatorUtils {
  ...
  public Set<String> getSupportedStepsV2() {
    return Sets.newHashSet(StepSpecTypeConstants.GITOPS_CREATE_PR, StepSpecTypeConstants.GITOPS_MERGE_PR,
        ...
        StepSpecTypeConstants.ELASTIGROUP_SWAP_ROUTE, StepSpecTypeConstants.TAS_ROLLING_DEPLOY, StepSpecTypeConstants.TAS_ROLLING_ROLLBACK, StepSpecTypeConstants.ROUTE_MAPPING);
  }
}
