...
public class GoogleFunctionsTrafficShiftStepPlanCreator extends CDPMSStepPlanCreatorV2<GoogleFunctionsTrafficShiftStepNode> {
    @Override
    ...
    @Override
    public PlanCreationResponse createPlanForField(PlanCreationContext ctx, GoogleFunctionsTrafficShiftStepNode stepElement) {
    ...
    protected StepParameters getStepParameters(PlanCreationContext ctx, GoogleFunctionsTrafficShiftStepNode stepElement) {
        ...
        googleFunctionsTrafficShiftStepParameters.setGoogleFunctionDeployWithoutTrafficStepFnq(googleFunctionDeployWithoutTrafficStepFnq);
