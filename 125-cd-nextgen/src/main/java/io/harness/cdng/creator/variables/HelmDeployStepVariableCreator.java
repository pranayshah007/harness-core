...
public class HelmDeployStepVariableCreator extends GenericStepVariableCreator<HelmDeployStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.HELM_DEPLOY);
  }
