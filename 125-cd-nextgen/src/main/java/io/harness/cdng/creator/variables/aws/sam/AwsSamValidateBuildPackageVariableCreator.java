...
public class AwsSamValidateBuildPackageVariableCreator
    extends GenericStepVariableCreator<AwsSamValidateBuildPackageStepNode> {
  @Override
  public Set<String> getSupportedStepTypes() {
    return Collections.singleton(StepSpecTypeConstants.AWS_SAM_VALIDATE_BUILD_PACKAGE);
  }
