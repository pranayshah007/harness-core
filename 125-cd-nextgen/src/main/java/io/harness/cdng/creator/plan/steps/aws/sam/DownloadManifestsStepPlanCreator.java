...
public class DownloadManifestsStepPlanCreator extends CDPMSStepPlanCreatorV2<DownloadManifestsStepNode> {
  ...
  @Override
  public PlanCreationResponse createPlanForField(PlanCreationContext ctx, DownloadManifestsStepNode stepNode) {
    return super.createPlanForField(ctx, stepNode);
  }

  @Override
  protected StepParameters getStepParameters(PlanCreationContext ctx, DownloadManifestsStepNode stepNode) {
