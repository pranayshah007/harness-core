...
public class EcsBlueGreenCreateServiceStepPlanCreator extends CDPMSStepPlanCreatorV2<EcsBlueGreenCreateServiceStepNode> {
    @Override
    ...
    @Override
    public PlanCreationResponse createPlanForField(PlanCreationContext ctx, EcsBlueGreenCreateServiceStepNode  stepElement) {
