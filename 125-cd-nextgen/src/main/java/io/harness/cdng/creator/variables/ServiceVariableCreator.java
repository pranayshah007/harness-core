...
public class ServiceVariableCreator {
    ...
    if (typeField != null) {
      switch (typeField.getNode().getCurrJsonNode().textValue()) {
        ...
        case ServiceSpecType.ECS:
          ...
          if (specNode != null) {
            addVariablesForKubernetesHelmServerlessElasticgroupEcsServiceSpec(specNode, yamlPropertiesMap);
          }
          break;
  ...
  private void addVariablesForKubernetesHelmServerlessElasticgroupEcsServiceSpec(
