  ...
  public TaskChainResponse executeAsgTask(Ambiance ambiance, StepElementParameters stepElementParameters,
    ...
    AsgCanaryDeployRequest asgCanaryDeployRequest =
        AsgCanaryDeployRequest.builder()
            ...
            .asgLaunchTemplateContent(asgStepExecutorParams.getAsgStoreManifestsContent().getAsgLaunchTemplateContent())
            .asgConfigurationContent(asgStepExecutorParams.getAsgStoreManifestsContent().getAsgConfigurationContent())
            .asgScalingPolicyContentList(
                asgStepExecutorParams.getAsgStoreManifestsContent().getAsgScalingPolicyContentList())
            .asgScheduledUpdateGroupActionContentList(
                asgStepExecutorParams.getAsgStoreManifestsContent().getAsgScheduledUpdateGroupActionContentList())
            .serviceNameSuffix(CANARY_SUFFIX)
            .nrOfInstances(asgSpecParameters.nrOfInstances.getValue())
            .build();
