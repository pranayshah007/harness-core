...
@Slf4j
public class AwsSamValidateBuildPackageStep extends TaskChainExecutableWithRollbackAndRbac {
  ...
  public StepResponse finalizeExecutionWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
    ...
    return StepResponse.builder().status(Status.SUCCEEDED).stepOutcome(null).build();
  }
