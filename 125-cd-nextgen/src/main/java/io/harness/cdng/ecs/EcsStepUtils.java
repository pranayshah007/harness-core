...
public class EcsStepUtils extends CDStepHelper {
  ...
  @Inject
  private EcsEntityHelper ecsEntityHelper;
  ...
  public GitStoreDelegateConfig getGitStoreDelegateConfig(
    ...
    return getGitStoreDelegateConfig(gitStoreConfig, connectorDTO, manifestOutcome, gitStoreConfig.getPaths().getValue(), ambiance);
  }
