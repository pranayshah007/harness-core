...
public class EcsBlueGreenRollbackStep extends TaskExecutableWithRollbackAndRbac<EcsCommandResponse> {
    ...
    public StepResponse handleTaskResultWithSecurityContext(Ambiance ambiance, StepElementParameters stepParameters,
        ...
        try {
            ...
            StepResponse.StepResponseBuilder stepResponseBuilder =
                    StepResponse.builder().unitProgressList(ecsBlueGreenRollbackResponse.getUnitProgressData().getUnitProgresses());
    ...
    private StepResponse generateStepResponse(
            Ambiance ambiance, EcsBlueGreenRollbackResponse ecsBlueGreenRollbackResponse,
            StepResponse.StepResponseBuilder stepResponseBuilder) {
    ...
    public TaskRequest obtainTaskAfterRbac(Ambiance ambiance, StepElementParameters stepParameters, StepInputPackage inputPackage) {
        ...
        EcsBlueGreenRollbackRequestBuilder ecsBlueGreenRollbackRequestBuilder =
                EcsBlueGreenRollbackRequest.builder()
                        ...
                        .oldServiceCreateRequestBuilderString(ecsBlueGreenPrepareRollbackDataOutcome.getCreateServiceRequestBuilderString())
        ...
        OptionalSweepingOutput ecsBlueGreenSwapTargetGroupsStartDataOptional = executionSweepingOutputService.resolveOptional(ambiance,
                RefObjectUtils.getSweepingOutputRefObject(ecsBlueGreenRollbackStepParameters.getEcsBlueGreenSwapTargetGroupsFnq() + "."
        ...
        ecsBlueGreenRollbackRequestBuilder.isTargetShiftStarted(ecsBlueGreenSwapTargetGroupsStartOutcome.isTrafficShiftStarted());
        return ecsStepCommonHelper
                .queueEcsTask(stepParameters, ecsBlueGreenRollbackRequestBuilder.build(), ambiance,
                        EcsExecutionPassThroughData.builder().infrastructure(infrastructureOutcome).build(), true)
                .getTaskRequest();
