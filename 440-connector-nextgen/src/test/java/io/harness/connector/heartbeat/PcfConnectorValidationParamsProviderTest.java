...
public class PcfConnectorValidationParamsProviderTest extends CategoryTest {
  ...
  @InjectMocks private PcfConnectorValidationParamsProvider pcfConnectorValidationParamsProvider;
  ...
  public void testGetConnectorValidationParams() {
    ...
    ConnectorValidationParams connectorValidationParams =
        pcfConnectorValidationParamsProvider.getConnectorValidationParams(
    ...
    assertThat(connectorValidationParams.getConnectorType()).isEqualTo(ConnectorType.PCF);
    assertThat(connectorValidationParams).isInstanceOf(PcfValidationParams.class);
  ...
  private PcfConnectorDTO getConnectorConfigDTO() {
