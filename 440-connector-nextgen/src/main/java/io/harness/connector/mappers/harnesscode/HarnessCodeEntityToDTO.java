...
public class HarnessCodeEntityToDTO
    implements ConnectorEntityToDTOMapper<HarnessCodeConnectorDTO, HarnessCodeConnector> {
  @Override
  public HarnessCodeConnectorDTO createConnectorDTO(HarnessCodeConnector connector) {
    return HarnessCodeConnectorDTO.builder().url(connector.getUrl()).build();
  }
}
