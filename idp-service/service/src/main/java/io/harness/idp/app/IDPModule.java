...
import io.harness.idp.namespace.resources.NamespaceResourceImpl;
import io.harness.idp.namespace.service.NamespaceNameService;
import io.harness.idp.namespace.service.NamespaceNameServiceImpl;
...
public class IDPModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    bind(NamespaceNameService.class).to(NamespaceNameServiceImpl.class);
    ...
    bind(NamespaceResource.class).to(NamespaceResourceImpl.class);

//    bind(NamespaceRepository.class).to(NamespaceRepositoryCustomImpl.class);
  }
