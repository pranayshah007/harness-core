...
public class GitIntegrationServiceImpl implements GitIntegrationService {
  ...
  private static final String INVALID_SCHEMA_FOR_INTEGRATIONS = "Invalid json schema for integrations config for account - {}";
  ...
  public void createAppConfigForGitIntegrations(String accountIdentifier, String orgIdentifier,
    ...
    String schemaForIntegrations = ConfigManagerUtils.getJsonSchemaBasedOnConnectorTypeForIntegrations(connectorTypeAsString);
    if(!ConfigManagerUtils.isValidSchema(integrationConfigs, schemaForIntegrations)){
      throw new InvalidRequestException(INVALID_SCHEMA_FOR_INTEGRATIONS);
    }
