...
public class IDPSpecStep implements ChildExecutable<IntegrationStageStepParametersPMS> {
  public static final StepType STEP_TYPE =
      StepType.newBuilder().setType("IDPSPECPMS").setStepCategory(StepCategory.STEP).build();
