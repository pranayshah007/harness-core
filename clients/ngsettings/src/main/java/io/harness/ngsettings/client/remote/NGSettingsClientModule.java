...
public class NGSettingsClientModule extends AbstractModule {
  ...
  private NGSettingsClientFactory ngSettingsClientFactory(KryoConverterFactory kryoConverterFactory) {
    return new NGSettingsClientFactory(ngSettingsClientConfig, serviceSecret, new ServiceTokenGenerator(),
  ...
  @Named("PRIVILEGED")
  @Singleton
  private NGSettingsClientFactory privilegedNgSettingsClientFactory(KryoConverterFactory kryoConverterFactory) {
    return new NGSettingsClientFactory(ngSettingsClientConfig, serviceSecret, new ServiceTokenGenerator(),
