...
@Slf4j
public abstract class AbstractContainerStepV2 implements AsyncExecutableWithRbac<StepElementParameters> @Inject
private ContainerStepCleanupHelper containerStepCleanupHelper;
...
@Override
public void handleForCallbackId(Ambiance ambiance, StepElementParameters containerStepInfo, List<String> allCallbackIds,
...
public StepResponse handleAsyncResponse(
  ...
  Outcome extraOutcome = getAnyOutComeForStep(ambiance, stepParameters, responseDataMap);
...
public TaskData getStepTask(Ambiance ambiance, StepElementParameters containerStepInfo, String accountId, String logKey,
...
public abstract UnitStep getSerialisedStep(Ambiance ambiance, StepElementParameters containerStepInfo, String accountId,
    String logKey, long timeout, String parkedTaskId);

public abstract Outcome getAnyOutComeForStep(
    Ambiance ambiance, StepElementParameters stepParameters, Map<String, ResponseData> responseDataMap);
}
