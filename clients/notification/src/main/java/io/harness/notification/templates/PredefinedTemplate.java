...
public enum PredefinedTemplate {
  ...
  SLACK_CCM_BUDGET_ACTUAL_ALERT("templates/slack_ccm_budget_actual_alert.txt", "slack_ccm_budget_actual_alert"),
  SLACK_CCM_BUDGET_FORECAST_ALERT("templates/slack_ccm_budget_forecast_alert.txt", "slack_ccm_budget_forecast_alert");
