...
import io.harness.entities.MonitoredServiceEntity;
...
import io.harness.entities.VerificationJobEntity;
...
public class ChangeDataCaptureModule extends AbstractModule {
  ...
  private void bindEntities() {
    ...
    cdcEntityMultibinder.addBinding().to(VerificationJobEntity.class);
    cdcEntityMultibinder.addBinding().to(MonitoredServiceEntity.class);
  }
